...
{
    public partial class AddDuAn : System.Web.UI.Page
    {
        ...
        protected void loadex()
        {
            ...
            {
                using (var conn = new SqlDataAdapter("Select * from Duan", cnn))
                {
        ...
        protected void load()
        {
            ...
            adapter.Fill(dt, "Duan");
            lvCustomers.DataSource = dt.Tables["Duan"];
        ...
        protected void gui_Click(object sender, EventArgs e)
        {
            ...
            if (MaDuAn.Text.Equals(""))
            {
                LDuAn.Visible = true;
                LDuAn.Text = "Mã Dự Án Không Được Bỏ Trống";
                MaDuAn.Focus();
            }
            ...
            else
            {
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                {
                    if (Page.IsValid && FileUpload1.HasFile)
                    {
                        ...
                        using (var conn = new SqlDataAdapter("INSERT Duan VALUES(N'" + MaDuAn.Text.Trim() + "',N'" + TenDuAn.Text.Trim() + "','" + NgayBatDau.Text.Trim() + "',N'" + NgayKetThuc.Text.Trim() + "',N'" + txtEmpName.Text.Trim() + "',N'" + txtEmpName1.Text.Trim() + "',N'" + txtEmpName2.Text.Trim() + "','0%',N'" + Ghichu.Text.Trim() + "',N'" + fileName + "')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                        }
                        Label2.Text = "Chúc Mừng Bạn Thêm Dự Án Thành Công";
                    }
                    else
                    {
                        using (var conn = new SqlDataAdapter("INSERT Duan VALUES(N'" + MaDuAn.Text.Trim() + "',N'" + TenDuAn.Text.Trim() + "','" + NgayBatDau.Text.Trim() + "',N'" + NgayKetThuc.Text.Trim() + "',N'" + txtEmpName.Text.Trim() + "',N'" + txtEmpName1.Text.Trim() + "',N'" + txtEmpName2.Text.Trim() + "','0%',N'" + Ghichu.Text.Trim() + "',N'')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                        }
