...
{
    public partial class XuatBaoGia : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where MaSP like '%" + txt_autocomplete.Text.Trim() + "%'", conn);
        ...
        protected void btnViewDetails_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("Ttbaogia.aspx?idSP=" + e.CommandArgument + "&Madon=" + masp);         
        }
