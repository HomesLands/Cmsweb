<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="duyetdon2.aspx.cs" Inherits="Banhang.Admin.duyetdon2" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <asp:Label ID="Label3" runat="server" Text="Label" Style="color: #FF0000; font-style: italic"></asp:Label>                     
                            </div>
                            <div class="card-body">
                                        ...
                                        <asp:ListView ID="lvCustomers" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnPagePropertiesChanging="lvCustomers_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="Label5" runat="server"><%# Eval("StatusCHT") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server"><%# Eval("NDCHT") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server"><%# Eval("Tenduyetbuoc2") %></asp:Label>
                                                    <asp:Label ID="Label7" runat="server"><%# Eval("StatusPKH") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label10" runat="server"><%# Eval("NDPKH") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label11" runat="server"><%# Eval("Tenduyetbuoc3") %></asp:Label>
                                                    <asp:Label ID="Label12" runat="server"><%# Eval("StatusGD") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label13" runat="server"><%# Eval("NDGGD") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label14" runat="server"><%# Eval("NDNYC") %></asp:Label>
                                                </td>
                                                <td>
