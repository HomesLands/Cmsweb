...
{
    public partial class TtAddSanPham : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                using (Bitmap bitMap = new Bitmap(barCode.Length * 40, 80))
                {
                    using (Graphics graphics = Graphics.FromImage(bitMap))
                    {
                        ...
                        {
                            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where MaRFID like '%" + RFID.Text.Trim() + "%' ", cnn);
                            SqlDataAdapter adapter;
                            adapter = new SqlDataAdapter(cmd);
                            DataSet dt = new DataSet();
                            ...
                            else
                            {
                                ...
                                using (var conn2 = new SqlDataAdapter("Delete from SanPhamTBE where MaSP='" + masp + "' and MaRFID='" + ID1 + "' ", cnn))
                                {
                                    var data = new DataTable();
                                    conn2.Fill(data);
                                }
                                using (var conn = new SqlDataAdapter("Insert SanPhamTBE values('" + masp + "',N'" + TextBox1.Text.Trim() + "','" + RFID.Text.Trim() + "','" + MaModel.Text.Trim() + "',N'" + tensp.Text.Trim() + "','" + date + "',1,'" + dongia.Text.Trim() + "','" + masp + "',N'" + diachi.Text.Trim() + "',N'" + ghichu.Text.Trim() + "','action')", cnn))
                                {
                                    var data = new DataTable();
                                    conn.Fill(data);
