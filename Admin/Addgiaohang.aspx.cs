...
namespace TBE.Admin
{
    public partial class Addgiaohang : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'giaonhan' ", conn);
        ...
        protected void btnViewOrders_Command(object sender, CommandEventArgs e)
        {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                {
                    using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + Label2.Text + "')", cnn))
                    {
