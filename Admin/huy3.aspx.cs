...
{
    public partial class huy3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    madon.Text = Request.QueryString["idnsx"].ToString();
        ...
        public void load1() {
            ...
            if (Label3.Text.Equals("kho") || Label3.Text.Equals("giaonhan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        ...
        public void tkc()
        {
            ...
            SqlConnection conn5 = new SqlConnection(constr1);
            string sql5 = "select * from Phieuycvt where Mahoadon='" + madon.Text.Trim() + "' ";
            SqlCommand cmd5 = new SqlCommand(sql5, conn5);
            conn5.Open();
            SqlDataReader reader5 = cmd5.ExecuteReader();
            while (reader5.Read())
            {
                Label6.Text = reader5["Tenduyetbuoc2"].ToString();
            }
            reader5.Close();
            conn5.Close();
        }
        ...
        protected void gui_Click(object sender, EventArgs e) {         
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                SqlConnection conn1 = new SqlConnection(constr);
                string username = Session["ADminID"].ToString();
                string sql = "select  * from Phieuycvt where Mahoadon='" + madon.Text.Trim() + "' ";
                SqlCommand cmd1 = new SqlCommand(sql, conn1);
                conn1.Open();
                SqlDataReader reader = cmd1.ExecuteReader();
                while (reader.Read())
                {
                    huynotification.Text = reader["Manager"].ToString();
                }
                reader.Close();
                conn1.Close();
                if (huynotification.Text.Equals("nhanvien") || huynotification.Text.Equals("gsat") || huynotification.Text.Equals("gsd") || huynotification.Text.Equals("gsck") || huynotification.Text.Equals("gs")|| huynotification.Text.Equals("thohan") || huynotification.Text.Equals("thocokhi") || huynotification.Text.Equals("baotridien") || huynotification.Text.Equals("baotricokhi") || huynotification.Text.Equals("QSQC"))
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusNYC=N'noplai',StatusPKH=N'Hoàn Đơn',NDPKH=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huy1' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        ...
                        if (lydoduyet.Text.Equals(""))
                        {
                            Label1.Visible = true;
                            Label1.Text = "Lý Do Không Được Bỏ Trống";
                            lydoduyet.Focus();
                        }
                        else
                        {
                            ...
                            using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Hủy đơn trực tiếp về NV YCVT',N'" + lydoduyet.Text.Trim() + "',N'TPDA','" + datacom + "','1cap','" + datetest + "')", cnn))
                            {
                            ...
                            conn2.Fill(data);
                            Label2.Text = "Xác Nhận Thành Công";
                            Response.Redirect("~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text);
                        }
                     }
                }else if(huynotification.Text.Equals("giaonhan") || huynotification.Text.Equals("muahang") || huynotification.Text.Equals("it") || huynotification.Text.Equals("thukho") || huynotification.Text.Equals("thuquy") || huynotification.Text.Equals("nvhcns") || huynotification.Text.Equals("nvpda") || huynotification.Text.Equals("kho") || huynotification.Text.Equals("ketoan") || huynotification.Text.Equals("chihuytruong"))
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusNYC=N'noplai',StatusPKH=N'Hoàn Đơn',NDPKH=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huytp' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        var data = new DataTable();
                        if (lydoduyet.Text != "")
                        {
                ...
                }else if(huynotification.Text.Equals("ppda") || huynotification.Text.Equals("tpkehoach") || huynotification.Text.Equals("tpda") || huynotification.Text.Equals("tpmh") || huynotification.Text.Equals("ktt") || huynotification.Text.Equals("tpns"))
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusNYC=N'noplai',StatusPKH=N'Hoàn Đơn',NDPKH=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huygd' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        var data = new DataTable();
                        if (lydoduyet.Text != "")
                        {
