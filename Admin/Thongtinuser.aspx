<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Thongtinuser.aspx.cs" Inherits="Banhang.Admin.Thongtinuser" %>
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="tenid" runat="server"><%# Eval("MaAD") %></asp:Label>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="ThongtinAdmin.aspx?idad=<%#Eval("MaAD") %>" data-tooltip="<%#Eval("MaAD") %>">KPI</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </ItemTemplate>
