<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Chantruycap.aspx.cs" Inherits="Banhang.Admin.Chantruycap" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <form id="frm" runat="server">
        ...
        <asp:Label ID="lblHostName" runat="server" /><br />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <asp:Label ID="Label3" runat="server" Style="color: #FF0000; font-style: italic; font-size: 15px;" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
