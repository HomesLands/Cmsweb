<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="TheodoidonPXK.aspx.cs" Inherits="TBE.Admin.TheodoidonPXK" %>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:ListView ID="lvCustomers" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnPagePropertiesChanging="lvCustomers_PagePropertiesChanging1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="align-content: center;">STT</th>
                                                        <th style="align-content: center;">Mã Phiếu Xuất Kho</th>
                                                        <th style="align-content: center;">Mã Phiếu YCVT</th>
                                                        <th style="align-content: center;">Người Nhận</th>
                                                        <th style="align-content: center;">Ngày Tạo</th>
                                                        <th style="align-content: center;">Xuất Cho Kho</th>
                                                        <th style="align-content: center;">Xuất Từ Kho</th>
                                                        <th style="align-content: center;">Trạng Thái</th>
                                                        <th style="align-content: center;">Chi Tiết</th>
                                                    </tr>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label9" runat="server"><%# Eval("Sochungtu") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server"><%# Eval("Nguoinhan") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server"><%# Eval("Date") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server"><%# Eval("Congtrinhxuat") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label10" runat="server"><%# Eval("Noixuatkho") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server"><%# Eval("StatusPXK") %></asp:Label>
                                                </td>

                                                <td>
                                                    <a href="ViewPXKtheoYCVT.aspx?idnsx=<%#Eval("Mahoadon") %>" data-tooltip="<%#Eval("Mahoadon") %>">Xem Đơn</a>
                                                </td>
                                            </ItemTemplate>
                                        </asp:ListView>
                                    </asp:Panel>
