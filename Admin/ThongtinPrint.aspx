<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ThongtinPrint.aspx.cs" Inherits="Banhang.Admin.ThongtinPrint" ValidateRequest="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <asp:Button ID="print" runat="server" OnClientClick="javascript:window.print();" class="btn btn-primary pull-left" Text="Print" />
                            </div>
                        </div>
                    </div>
                </div>
