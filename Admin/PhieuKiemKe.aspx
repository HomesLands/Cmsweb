<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="PhieuKiemKe.aspx.cs" Inherits="Banhang.Admin.PhieuKiemKe" %>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Thêm Phiếu Kiểm Kê</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Phiếu Kiểm Kê :</label>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Tên Kho:</label>
                                            <asp:DropDownList ID="Tenkho" runat="server" AutoPostBack="True" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Người Kiểm Kê:</label>
                                            <asp:TextBox ID="Nguoikiemke" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="LNguoikiemke" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Lý Do Kiểm:</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Thông Tin Phiếu Kiểm Kê</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <HeaderTemplate>
                                            <table class="table" border="1">
                                                <tr>
                                                    ...
                                                    <th style="width: 420px; align-content: center;">Mã Phiếu Kiểm Kê</th>
                                                    <th style="width: 400px; align-content: center;">Ngày Xuất</th>
                                                    <th style="width: 100px; align-content: center;">Xem Phiếu Kiểm Kê</th>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="ViewKiemKe.aspx?idnsx=<%#Eval("Mahoadon") %>" data-tooltip="<%#Eval("Mahoadon") %>">Xem Đơn</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
