...
namespace Banhang.Admin {
    public partial class duyetdon : System.Web.UI.Page {
        ...
        protected void load() {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Tenduyetbuoc1=N'" + hotenad.Text.Trim() + "' and StatusCHT=N'Chưa Duyệt' and Display='on' ORDER BY Date DESC  ", conn);
