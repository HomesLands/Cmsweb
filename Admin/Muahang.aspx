<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Muahang.aspx.cs" Inherits="Banhang.Admin.Muahang" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <asp:Button ID="Button15" runat="server" OnClick="Button15_Click" class="btn btn-primary pull-left" Text="Summary YCVT" />
                                ...
                                <asp:Button ID="Button16" runat="server" OnClick="Button16_Click" class="btn btn-primary pull-left" Text="Theo Dõi Đơn Duyệt" />
                                ...
                                <asp:Button ID="Button17" runat="server" OnClick="Button17_Click" class="btn btn-primary pull-left" Text="Theo Dõi Đơn Hủy" />
                                <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" class="btn btn-primary pull-left" Text="Đơn Hoàn Thành" />
