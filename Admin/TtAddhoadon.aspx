<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="TtAddhoadon.aspx.cs" Inherits="Banhang.Admin.TtAddhoadon" ValidateRequest="false" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Xuất Kho:</label><br />
                                            <asp:TextBox ID="maxuat" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Tên Công Ty:</label><br />
                                            <asp:TextBox ID="tencongty" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Công Trình Xuất:</label><br />
                                            <asp:TextBox ID="Congtrinhxuat" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Người Nhận:</label><br />
                                            <asp:TextBox ID="Nguoinhan" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Nơi Xuất Kho:</label><br />
                                            <asp:TextBox ID="Noixuatkho" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Ngày Xuất:</label><br />
                                            <asp:TextBox ID="ngayxuat" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Số Chứng Từ:</label><br />
                                            <asp:TextBox ID="Sochungtu" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Tên Sản Phẩm</label><br />
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã RFID</label><br />
                                            <asp:TextBox ID="RFID" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Model:</label><br />
                                            <asp:TextBox ID="MaModel" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Label1" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Đơn vị tinh:</label><br />
                                            <asp:TextBox ID="dongia" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Ldongia" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Địa Chỉ:</label><br />
                                            <asp:TextBox ID="diachi" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Ldiachi" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Ghi Chú:</label><br />
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Số Lượng Tồn:</label><br />
                                            <asp:TextBox ID="slton" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Lý Do Xuất:</label><br />
                                            <asp:TextBox ID="Lydoxuat" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Số lượng:</label><br />
                                            <asp:DropDownList ID="Soluong" runat="server" class="form-control">
                                ...
                                <asp:Button ID="Button1" runat="server" OnClick="capnhat_Click" class="btn btn-primary pull-left" Text="Thêm" />
                            </div>
                        </div>
                    </div>
                </div>
