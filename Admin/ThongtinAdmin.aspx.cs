    ...
    public partial class ThongtinAdmin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    load1();
                    Label4.Text = "Welcome To " + " " + Session["ADminID"];
                    load();
                    Label6.Visible = false;
                    Image1.ImageUrl = Label6.Text;
                    anhuser.Visible = false;
                    Image2.ImageUrl = anhuser.Text;
                    ...
                    bophan.Visible = false;
                    DropDownList3.SelectedValue = Label5.Text;
                    DropDownList2.SelectedValue = bophan.Text;
                    kho1.Visible = false;
                    kho2.Visible = false;
                    kho3.Visible = false;
                    kho4.Visible = false;
        ...
        public void load1()
        {
            ...
            while (reader.Read())
            {
                Label16.Text = reader["Manager"].ToString();
                hotenad.Text = reader["HoTen"].ToString();
            }
            reader.Close();
            conn1.Close();
            if (Label16.Text.Equals("khach"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("ketoan") || Label16.Text.Equals("giaonhan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("muahang") || Label16.Text.Equals("thukho") || Label16.Text.Equals("thuquy") || Label16.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("chihuytruong"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("ppda") || Label16.Text.Equals("tpkehoach") || Label16.Text.Equals("tpda") || Label16.Text.Equals("tpmh") || Label16.Text.Equals("ktt"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("nhanvien") || Label16.Text.Equals("gsat") || Label16.Text.Equals("gsd") || Label16.Text.Equals("gsck") || Label16.Text.Equals("gs"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("thohan") || Label16.Text.Equals("thocokhi") || Label16.Text.Equals("baotridien") || Label16.Text.Equals("baotricokhi") || Label16.Text.Equals("QSQC"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        }
        ...
        protected void load()
        {
            ...
            string maad = Request.QueryString["idad"].ToString();
            SqlConnection conn = new SqlConnection(connectionstring);
            string sql = "select  * from Admin where MaAD=@maad";
            ...
            while (reader.Read())
            {
                tenad.Text = reader["HoTen"].ToString();
                ngaysinhtx.Text = reader["NgaySinh"].ToString();
                diachi.Text = reader["DiaChi"].ToString();
                sdt.Text = reader["DT"].ToString();
                email.Text = reader["Email"].ToString();
                usernbame.Text = reader["UserName"].ToString();
                Label6.Text = reader["Anh"].ToString();
                anhuser.Text = reader["Anhuser"].ToString();
                CCCD.Text = reader["CMND"].ToString();
                bophan.Text = reader["Bophan"].ToString();
                password.Text = reader["PassWord"].ToString();
                Label5.Text = reader["Manager"].ToString();
                hotenad.Text = reader["HoTen"].ToString();
            }
            reader.Close();
            conn.Close();
        ...
        protected void xoa_Click(object sender, EventArgs e)
        {
            ...
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("Delete from Admin where MaAD=@maad", conn);
            cmd.Parameters.AddWithValue("@maad", maad);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            ...
            adapter.Fill(dt);
            adapter.Dispose();
            Label2.Text = "Xóa Admin Thành Công";
        ...
        protected void capnhat_Click(object sender, EventArgs e)
        {
            ...
            if (tenad.Text.Equals(""))
            {
                Label1.Visible = true;
                Label1.Text = "Tên Admin Không Được Bỏ Trống";
                tenad.Focus();
            }

            if (diachi.Text.Equals(""))
            {
                Label7.Visible = true;
                Label7.Text = "Địa Chỉ Không Được Bỏ Trống";
                diachi.Focus();
            }
            if (sdt.Text.Equals(""))
            {
                Label8.Visible = true;
                Label8.Text = "Số Điện Thoại Không Được Bỏ Trống";
                sdt.Focus();
            }

            if (usernbame.Text.Equals(""))
            {
                Label3.Visible = true;
                Label3.Text = "UserName Không Được Bỏ Trống";
                usernbame.Focus();
            }
            if (email.Text.Equals(""))
            {
                Label9.Visible = true;
                Label9.Text = "Email Không Được Bỏ Trống";
                email.Focus();
            }
            if (password.Text.Equals(""))
            {
                Label10.Visible = true;
                Label10.Text = "Password Không Được Bỏ Trống";
                password.Focus();
            }
            if (FileUpload1.HasFile)
            {
                string fileName1 = "../AnhUser/" + DateTime.Now.ToString("ddMMyyyy_hhmmss_tt_") + FileUpload1.FileName;
                string filePath1 = MapPath(fileName1);
                FileUpload1.SaveAs(filePath1);
                Image2.ImageUrl = fileName1;

                // string ngaysinh = ngaysinhtx.ToString("MM/dd/yyyy");
                string maad = Request.QueryString["idad"].ToString();
                string bophan = DropDownList2.SelectedValue.ToString().Trim();
                string chucvu = DropDownList3.SelectedValue.ToString().Trim();
                string chucvu1 = DropDownList3.SelectedItem.ToString().Trim();
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@ten,NgaySinh=@ngaysinh,DiaChi=@dc,DT=@dt,UserName=@user,Email=@email,Anhuser=@anhuser,CMND=@cmnd,Bophan=@bophan,PassWord=@pass,Manager=@chucvu,Tenmanager=@chucvu1 where MaAD=@maad";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@maad", maad);
                cmd.Parameters.AddWithValue("@ten", tenad.Text);
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhtx.Text);
                cmd.Parameters.AddWithValue("@dc", diachi.Text);
                cmd.Parameters.AddWithValue("@dt", sdt.Text);
                cmd.Parameters.AddWithValue("@email", email.Text);
                cmd.Parameters.AddWithValue("@user", usernbame.Text);
                cmd.Parameters.AddWithValue("@anhuser", fileName1);
                cmd.Parameters.AddWithValue("@cmnd", CCCD.Text);
                cmd.Parameters.AddWithValue("@bophan", bophan);
                cmd.Parameters.AddWithValue("@pass", password.Text);
                cmd.Parameters.AddWithValue("@chucvu", chucvu);
                cmd.Parameters.AddWithValue("@chucvu1", chucvu1);
                conn.Open();
                cmd.ExecuteNonQuery();
                conn.Close();
                load();
                Label2.Text = "Chúc Mừng Bạn Thay đổi Thông Tin Admin Thành Công";
            }
           else if (FileUpload.HasFile)
            {
                string fileName = "../Data Image/" + DateTime.Now.ToString("ddMMyyyy_hhmmss_tt_") + FileUpload.FileName;
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@ten,NgaySinh=@ngaysinh,DiaChi=@dc,DT=@dt,UserName=@user,Email=@email,Anh=@anh,CMND=@cmnd,Bophan=@bophan,PassWord=@pass,Manager=@chucvu,Tenmanager=@chucvu1 where MaAD=@maad";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@maad", maad);
                cmd.Parameters.AddWithValue("@ten", tenad.Text);
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhtx.Text);
          ...
          else  if (FileUpload.HasFile != false && FileUpload1.HasFile != false)
            {
                string fileName = "../Data Image/" + DateTime.Now.ToString("ddMMyyyy_hhmmss_tt_") + FileUpload.FileName;
                string filePath = MapPath(fileName);
                FileUpload.SaveAs(filePath);
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@ten,NgaySinh=@ngaysinh,DiaChi=@dc,DT=@dt,UserName=@user,Email=@email,Anh=@anh,Anhuser=@anhuser,CMND=@cmnd,Bophan=@bophan,PassWord=@pass,Manager=@chucvu,Tenmanager=@chucvu1 where MaAD=@maad";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@maad", maad);
                cmd.Parameters.AddWithValue("@ten", tenad.Text);
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhtx.Text);
           ...
           else 
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@ten,NgaySinh=@ngaysinh,DiaChi=@dc,DT=@dt,UserName=@user,Email=@email,CMND=@cmnd,Bophan=@bophan,PassWord=@pass,Manager=@chucvu,Tenmanager=@chucvu1 where MaAD=@maad";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@maad", maad);
                cmd.Parameters.AddWithValue("@ten", tenad.Text);
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhtx.Text);
