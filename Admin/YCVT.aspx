<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="YCVT.aspx.cs" Inherits="Banhang.Admin.YCVT" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" class="btn btn-primary pull-left" Text="Tạo Phiếu YCVT" />
                                <asp:Button ID="Button11" runat="server" OnClick="Button11_Click" class="btn btn-primary pull-left" Text="Tạo Phiếu YCVT" />
                                <asp:Button ID="Button12" runat="server" OnClick="Button12_Click" class="btn btn-primary pull-left" Text="Tạo Phiếu YCVT" />
                                <asp:Button ID="Button18" runat="server" OnClick="Button18_Click" class="btn btn-primary pull-left" Text="Tạo Phiếu YCVT" />
                                <asp:Button ID="Button15" runat="server" OnClick="Button15_Click" class="btn btn-primary pull-left" Text="YCVT Chưa Duyệt" />
                                <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" class="btn btn-primary pull-left" Text="Đơn Chưa Duyệt" />
                                <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" class="btn btn-primary pull-left" Text="Đơn Chưa Duyệt" />
                                <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" class="btn btn-primary pull-left" Text="Đơn Chưa Duyệt" />
                                <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" class="btn btn-primary pull-left" Text="Đơn Đã Duyệt" />
                                <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" class="btn btn-primary pull-left" Text="Đơn Đã Duyệt" />
                                <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" class="btn btn-primary pull-left" Text="Đơn Đã Duyệt" />
                                <asp:Button ID="Button16" runat="server" OnClick="Button16_Click" class="btn btn-primary pull-left" Text="YCVT Đang Xét Duyệt" />
                                <asp:Button ID="Button19" runat="server" OnClick="Button19_Click" class="btn btn-primary pull-left" Text="YCVT Đã Duyệt" />
                                <asp:Button ID="Button9" runat="server" OnClick="Button9_Click" class="btn btn-primary pull-left" Text="Theo Dõi Đơn Hủy" />
                                <asp:Button ID="Button13" runat="server" OnClick="Button13_Click" class="btn btn-primary pull-left" Text="Theo Dõi Đơn Hủy" />
                                <asp:Button ID="Button14" runat="server" OnClick="Button14_Click" class="btn btn-primary pull-left" Text="Theo Dõi Đơn Hủy" />
                                <asp:Button ID="Button17" runat="server" OnClick="Button17_Click" class="btn btn-primary pull-left" Text="YCVT Bị Hủy" />
                                <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" class="btn btn-primary pull-left" Text="Đơn Đã Duyệt" />
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="btn btn-primary pull-left" Text="Tạo User Duyệt Đơn" />
