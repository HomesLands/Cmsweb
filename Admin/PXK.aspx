<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="PXK.aspx.cs" Inherits="TBE.Admin.PXK" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <asp:Button ID="nguoivanchuyen" runat="server" class="btn btn-primary pull-left" OnClick="nguoivanchuyen_Click" Text="Thêm Giao Hàng" />
                                <asp:Button ID="thukho" runat="server" class="btn btn-primary pull-left" OnClick="thukho_Click" Text="Thêm Thủ Kho" />
                                <asp:Button ID="daxacnhan" runat="server" class="btn btn-primary pull-left" OnClick="daxacnhan_Click" Text="Đã Xác Nhận" />
                                <asp:Button ID="danggiao" runat="server" class="btn btn-primary pull-left" OnClick="danggiao_Click" Text="Đang Giao" />
                                <asp:Button ID="giaothatbai" runat="server" class="btn btn-primary pull-left" OnClick="giaothatbai_Click" Text="Giao Thất Bại" />
                                <asp:Button ID="thaygiaohang" runat="server" class="btn btn-primary pull-left" Text="Thay Đổi Giao Hàng" OnClick="thaygiaohang_Click" />
