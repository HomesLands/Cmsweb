...
namespace Banhang.Admin {
    public partial class theodoidonhuy : System.Web.UI.Page {
        ...
        protected void load()
        {
            ...
            if (Label3.Text.Equals("admin") || Label3.Text.Equals("giamdoc"))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where StatusGD=N'Hoàn Đơn' ORDER BY Date DESC", conn);
            ...
            else if (Label3.Text.Equals("kho") || Label3.Text.Equals("giaonhan") || Label3.Text.Equals("ketoan") || Label3.Text.Equals("muahang") || Label3.Text.Equals("chihuytruong") || Label3.Text.Equals("it") || Label3.Text.Equals("thukho") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("nvhcns") || Label3.Text.Equals("nvpda"))
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusPKH=N'Hoàn Đơn' ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
            ...
            else if (Label3.Text.Equals("nhanvien") || Label3.Text.Equals("gsat") || Label3.Text.Equals("gsd") || Label3.Text.Equals("gsck") || Label3.Text.Equals("gs") || Label3.Text.Equals("thohan") || Label3.Text.Equals("thocokhi") || Label3.Text.Equals("baotridien") || Label3.Text.Equals("baotricokhi") || Label3.Text.Equals("QSQC"))
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusCHT=N'Hoàn Đơn' ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
            ...
            else if (Label3.Text.Equals("ppda") || Label3.Text.Equals("tpkehoach") || Label3.Text.Equals("tpda") || Label3.Text.Equals("tpmh") || Label3.Text.Equals("ktt") || Label3.Text.Equals("tpns"))
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusGD=N'Hoàn Đơn' ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
