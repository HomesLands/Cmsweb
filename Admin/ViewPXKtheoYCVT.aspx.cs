...
namespace TBE.Admin
{
    public partial class ViewPXKtheoYCVT : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    loadicon();                   
                    anhgiaohang.Visible = false;
                    loadanhgiaohang();
                    Image2.ImageUrl= anhgiaohang.Text;
                    Image2.Visible = false;
                    ananhgiaohang.Visible = false;
                }
            }
        }
        ...
        public void loadanhgiaohang()
        {
            ...
            while (reader.Read())
            {
                anhgiaohang.Text = reader["Anhnhanhang"].ToString();
            }
            reader.Close();
            conn1.Close();
        }
        ...
        protected void load()
        {
            ...
            while (reader.Read())
            {
                tencongty.Text = reader["Tencongty"].ToString();
                diachi.Text = reader["Diachi"].ToString();
                Date.Text = reader["Date"].ToString();
                sophieu.Text = reader["Mahoadon"].ToString();
                Soycvt.Text = reader["Sochungtu"].ToString();
                xuatcongtrinh.Text = reader["Congtrinhxuat"].ToString();
                nguoinhan.Text = reader["Nguoinhan"].ToString();
                xuattai.Text = reader["Noixuatkho"].ToString();
                string ipsp = reader["MaSP"].ToString();
                Label5.Text = reader["StatusPXK"].ToString();

                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT * from vattuyeucau  where Mahoadon='" + Soycvt.Text.Trim() + "' ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "vattuyeucau");
                Repeater1.DataSource = dt.Tables["vattuyeucau"];
                Repeater1.DataBind();    
                if(Label5.Text.Equals("Xác Nhận Đơn"))
                {
                    dagiao.Visible = false;
                    giaothatbai.Visible = false;
                    giaolai.Visible = false;
                    tenhj.Visible = false;
                    FileUpload1.Visible = false;
                    Image1.Visible = false;
                }
                if (Label5.Text.Equals("Đang Giao Hàng"))
                {
                    danggiao.Visible = false;
                    giaolai.Visible = false;
                    themngh.Visible = false;
                    spe.Visible = false;
                }
                if (Label5.Text.Equals("Giao Lại"))
                {
                    dagiao.Visible = false;
                    giaothatbai.Visible = false;
                    giaolai.Visible = false;
                ...
                if (Label5.Text.Equals("Giao Thất Bại"))
                {
                    danggiao.Visible = false;
                    dagiao.Visible = false;
                    giaothatbai.Visible = false;
                ...
                if (Label5.Text.Equals("Giao Thành Công"))
                {
                    danggiao.Visible = false;
                    dagiao.Visible = false;
                    giaothatbai.Visible = false;
        ...
        private void LoadDataToDropDownList2()
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("Select * From Nguoivanchuyen where Roles='giaonhan' ", connectionstring);
            adapter.Fill(dataTable);
            themngh.DataSource = dataTable;
            themngh.DataTextField = "Tenuser"; //Text hiển thị 
            themngh.DataValueField = "Tenuser"; //Giá trị khi chọn
            themngh.DataBind();
        }
        public void chuky()
        {
            ...
            SqlCommand cmd2 = new SqlCommand("SELECT * from Xuatkho  where Mahoadon='" + madon + "'  ", conn2);
            SqlDataAdapter adapter2;
            adapter2 = new SqlDataAdapter(cmd2);
            DataSet dt2 = new DataSet();
            adapter2.Fill(dt2, "Xuatkho");
            Repeater2.DataSource = dt2.Tables["Xuatkho"];
            Repeater2.DataBind();
        }
        public void load1()
        {
            ...
            if (Label3.Text.Equals("muahang") || Label3.Text.Equals("it") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("nvhcns") || Label3.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        ...
        public void load113()
        {
            ...
            SqlConnection conn1 = new SqlConnection(constr);
            string username = Session["ADminID"].ToString();
            string sql = "select  * from Admin where HoTen=N'" + Label17.Text + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            conn1.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
                Label7.Text = reader["Anh"].ToString();
            }
            reader.Close();
            conn1.Close();      
        }
        ...
        public void load114()
        {
            ...
            SqlConnection conn1 = new SqlConnection(constr);
            string madon = Request.QueryString["idnsx"].ToString();
            string sql = "select  * from Xuatkho where Mahoadon=N'" + madon + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            conn1.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
                Label10.Text = reader["Nguoinhan"].ToString();
                Label12.Text = reader["Thukho"].ToString();
            }
            reader.Close();
            conn1.Close();
        }

        public void chukynguoinhan()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            string username = Session["ADminID"].ToString();
            string sql = "select  * from Admin where HoTen=N'" + Label10.Text.Trim() + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            conn1.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
                Label11.Text = reader["Anh"].ToString();
            }
            reader.Close();
            conn1.Close();
        }
        public void ckthukho()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            string username = Session["ADminID"].ToString();
            string sql = "select  * from Admin where HoTen=N'" + Label12.Text.Trim() + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            conn1.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
                Label16.Text = reader["Anh"].ToString();
            }
            reader.Close();
            conn1.Close();
        }
        ...
        protected void giaothatbai_Click(object sender, EventArgs e)
        {
            string madon = Request.QueryString["idnsx"].ToString();
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                using (var conn2 = new SqlDataAdapter("Update Xuatkho set StatusPXK=N'Giao Thất Bại'  where  Mahoadon='" + madon + "' ", cnn))
                {
                    var data = new DataTable();
                    conn2.Fill(data);
                    Response.Redirect("~/Admin/ViewPXKtheoYCVT.aspx?idnsx=" + madon);
                }
            }
        }

        protected void danggiao_Click(object sender, EventArgs e)
        {
            string madon = Request.QueryString["idnsx"].ToString();
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                {
                    Response.Write("<Script>alert('Vui Lòng Chọn Nhân Viên Giao Hàng')</Script>");
                }
                else
                {
                    using (var conn2 = new SqlDataAdapter("Update Xuatkho set Nguoigiaohanh=N'"+ themngh.SelectedValue.ToString()+ "',CkNguoiGiaohang=N'"+ Label7.Text+ "',StatusPXK=N'Đang Giao Hàng'   where  Mahoadon='" + madon + "' ", cnn))
                    {
                        var data = new DataTable();
                        conn2.Fill(data);
                        Response.Redirect("~/Admin/ViewPXKtheoYCVT.aspx?idnsx=" + madon);
        ...
        protected void dagiao_Click(object sender, EventArgs e)
        {
            string fileName1 = "../Anhgiaohang/" + DateTime.Now.ToString("ddMMyyyy_hhmmss_tt_") + FileUpload1.FileName;
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                using (var conn2 = new SqlDataAdapter("Update Xuatkho set CkThukho=N'" + Label16.Text + "',CKNguoinhan=N'" + Label11.Text + "',StatusPXK=N'Giao Thành Công',Anhnhanhang=N'"+fileName1+"'  where  Mahoadon='" + madon + "' ", cnn))
                {
                    var data = new DataTable();
                    conn2.Fill(data);
                    Response.Redirect("~/Admin/ViewPXKtheoYCVT.aspx?idnsx=" + madon);
        ...
        protected void giaolai_Click(object sender, EventArgs e)
        {
            string madon = Request.QueryString["idnsx"].ToString();
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                using (var conn2 = new SqlDataAdapter("Update Xuatkho set StatusPXK=N'Đang Giao Hàng'  where  Mahoadon='" + madon + "' ", cnn))
                {
                    var data = new DataTable();
                    conn2.Fill(data);
                    Response.Redirect("~/Admin/ViewPXKtheoYCVT.aspx?idnsx=" + madon);
        ...
        protected void themngh_SelectedIndexChanged(object sender, EventArgs e)
        {
            Label17.Text = themngh.SelectedValue.ToString();
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            string username = Session["ADminID"].ToString();
            string sql = "select  * from Admin where HoTen=N'" + Label17.Text + "'";
        ...
        protected void anhgh_Click(object sender, EventArgs e)
        {
            Image2.Visible = true;
            ananhgiaohang.Visible = true;
            anhgh.Visible = false;
        }

        protected void ananhgiaohang_Click(object sender, EventArgs e)
        {
            Image2.Visible = false;
            ananhgiaohang.Visible = false;
            anhgh.Visible = true;
