...
{
    public partial class ViewBaoGia : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT SanPhamTBE.*  FROM  PhieuXuatkho INNER JOIN SanPhamTBE ON PhieuXuatkho.MaSP=SanPhamTBE.MaSP where PhieuXuatkho.Madon='" + madon + "' ", conn);
            ...
            while (reader.Read())
            {
                Req.Text = reader["Req"].ToString();
                levent.Text = reader["SoEvent"].ToString();
                Subject.Text = reader["Subject"].ToString();
                Date.Text = reader["Date"].ToString();

                To.Text = reader["To"].ToString();
                Cc.Text = reader["Cc"].ToString();
                Contactor.Text = reader["Contactor"].ToString();
