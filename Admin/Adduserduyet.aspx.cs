...
namespace Banhang.Admin {
    public partial class Adduserduyet : System.Web.UI.Page {
        ...
        protected void load() {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT Mahoadon,Date,StatusYcvt from Phieuycvt where Tenduyetbuoc1=N'" + hotenad.Text.Trim() + "' and StatusYcvt=N'Chưa Duyệt' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Phieuycvt");
            Repeater1.DataSource = dt.Tables["Phieuycvt"];
            Repeater1.DataBind();
        }
        public void load1() {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            ...
            if (Label3.Text.Equals("muahang") || Label3.Text.Equals("giaonhan") || Label3.Text.Equals("it") || Label3.Text.Equals("thukho") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("nvhcns"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
