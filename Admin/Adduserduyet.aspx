<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Adduserduyet.aspx.cs" Inherits="Banhang.Admin.Adduserduyet" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Duyệt Đơn</h4>
                                        ...
                                        <HeaderTemplate>
                                            <table class="table" border="1">
                                                <tr>
                                                    ...
                                                    <th style="width: 120px; align-content: center;">Mã Đơn YCVT</th>
                                                    <th style="width: 100px; align-content: center;">Ngày Xuất</th>
                                                    <th style="width: 100px; align-content: center;">Tình Trạng</th>
                                                    <th style="width: 100px; align-content: center;">Duyệt Đơn</th>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label5" runat="server"><%# Eval("StatusYcvt") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="duyet.aspx?idnsx=<%#Eval("Mahoadon") %>" data-tooltip="<%#Eval("Mahoadon") %>">Duyệt Đơn</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
