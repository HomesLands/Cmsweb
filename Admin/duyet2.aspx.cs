...
{
    public partial class duyet2 : System.Web.UI.Page
    {
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            while (reader.Read())
            {
                Label4.Text = reader["Anh"].ToString();
            }
            reader.Close();
            conn1.Close();
            ...
            madon.Text = Request.QueryString["idnsx"].ToString(); 
                ...
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString())) {
                    ...
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "Phieuycvt");
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set Duyet2len3=N'on',StatusGD=N'Đã duyệt',NDGGD=N'" + lydoduyet.Text.Trim() + "',StatusYcvt=N'Đã Duyệt',StatusRecall=N'xacnhan',CKGD=N'" + Label4.Text + "',StatusRead=N'on',Duyet1len2=N'on' where Mahoadon='" + madon.Text.Trim() + "' ", cnn)) {
                    ...
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Đã duyệt',N'" + lydoduyet.Text.Trim() + "',N'GD','" + datacom + "','0cap','" + datetest + "')", cnn))
                        {
