<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="NotCopy.aspx.cs" Inherits="Banhang.Admin.NotCopy" ValidateRequest="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Cảnh Báo Truy Cập</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">                                           
                                            <asp:Label ID="Label3" runat="server" Style="color: #FF0000; font-style: italic; font-size: 15px;" class="bmd-label-floating">URL Này Bạn Không Có Quyền Truy Cập.Ip Máy Bạn Đã Được Nghi Nhận Lại...</asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
