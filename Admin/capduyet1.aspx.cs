...
namespace Banhang.Admin {
    public partial class capduyet1 : System.Web.UI.Page {
        ...
        private void BindRepeater() {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' ", conn);
        ...
        protected void btnViewOrders_Command(object sender, CommandEventArgs e) {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString())) {
                ...
                while (reader.Read()) {
                    ...
                    rolect.Text = reader["Bophan"].ToString();
                }
                reader.Close();
                conn1.Close();

                SqlCommand cmd = new SqlCommand("select * from Userduyetdon where Mauser='" + e.CommandArgument + "' ", cnn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                ...
                {
                    if (Label2.Text.Equals("chihuytruong"))
                    {
                        if (rolect.Text.Equals("Site Quận 9"))
                        {
                            string ttts =  Label2.Text+ "q9";                         
                            using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + ttts + "')", cnn))
                            {
                        ...
                        else if (rolect.Text.Equals("Site P&G"))
                        {
                            string ttt2 = Label2.Text + "pg";
                            using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + ttt2 + "')", cnn))
                            {
                                var data = new DataTable();
                                conn.Fill(data);
                                Label4.Text = "Thêm Thành Công";
                        ...
                        else if (rolect.Text.Equals("Site Đa Phước"))
                        {
                            string ttt3 = Label2.Text + "dp";
                            using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + ttt3 + "')", cnn))
                            {
                                var data = new DataTable();
                                conn.Fill(data);
                                Label4.Text = "Thêm Thành Công";
                        ...
                        else if (rolect.Text.Equals("Site Glomed"))
                        {
                            string ttt4 = Label2.Text + "glomed";
                            using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + ttt4 + "')", cnn))
                            {
                                var data = new DataTable();
                                conn.Fill(data);
                                Label4.Text = "Thêm Thành Công";
                        ...
                        else if (rolect.Text.Equals("Site SC Johnson"))
                        {
                            string ttt5 = Label2.Text + "johnson";
                            using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + ttt5 + "')", cnn))
                            {
                                var data = new DataTable();
                                conn.Fill(data);
                                Label4.Text = "Thêm Thành Công";
        ...
        protected void Button1_Command(object sender, CommandEventArgs e)
        {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                reader.Close();
                conn1.Close();
                using (var conn = new SqlDataAdapter("Delete from Userduyetdon where Mauser='" + e.CommandArgument + "'", cnn))
                {
                    var data = new DataTable();
                    conn.Fill(data);
