...
{
    public partial class huy4 : System.Web.UI.Page
    {
        ...
        public void laytenduyetgiamdoc()
        {
            ...
            while (reader5.Read())
            {
                Label6.Text = reader5["Tenduyetbuoc3"].ToString();
            }
            reader5.Close();
            conn5.Close();
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',CKTP=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusPKH=N'Hoàn Đơn',StatusNYC=N'noplai',StatusGD=N'Hoàn Đơn',NDGGD=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huy1' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        ...
                        else
                        {
                            ...
                            using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Hủy đơn trực tiếp về NV YCVT',N'" + lydoduyet.Text.Trim() + "',N'GD','" + datacom + "','0cap','" + datetest + "')", cnn))
                            {
                ...
                else if (huynotification.Text.Equals("giaonhan") || huynotification.Text.Equals("kho") || huynotification.Text.Equals("muahang") || huynotification.Text.Equals("it") || huynotification.Text.Equals("thukho") || huynotification.Text.Equals("thuquy") || huynotification.Text.Equals("nvhcns") || huynotification.Text.Equals("nvpda") || huynotification.Text.Equals("ketoan") || huynotification.Text.Equals("chihuytruong"))
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',CKTP=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusPKH=N'Hoàn Đơn',StatusNYC=N'noplai',StatusGD=N'Hoàn Đơn',NDGGD=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huytp' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        var data = new DataTable();
                        if (lydoduyet.Text != "")
                        {
                ...
                {
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set CKNYC=N'" + mau + "',CKCHT=N'" + mau + "',CKTP=N'" + mau + "',StatusCHT=N'Hoàn Đơn',StatusPKH=N'Hoàn Đơn',StatusNYC=N'noplai',StatusGD=N'Hoàn Đơn',NDGGD=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusRead=N'off',Duyet2len3=N'huygd' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                    {
                        var data = new DataTable();
                        if (lydoduyet.Text != "")
                        {
