...
{
    public partial class AddPhieuYCVT : System.Web.UI.Page
    {
        ...
        public void kiemtratencty()
        {
            ...
            reader.Close();
            conn1.Close();
            if (tenduyetb1.Text.Equals("nhanvien"))
            {
                if (tenduyetb2.Text.Equals("Site Quận 9"))
                {
        ...
        private void LoadDataToDropDownList2()
        {
            ...
            if (tenduyetb1.Text.Equals("nhanvien"))
            {
                if (tenduyetb2.Text.Equals("Site Quận 9"))
                {
                    ...
                    SqlConnection conn = new SqlConnection(connectionstring);
                    DataTable dataTable = new DataTable();
                    SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles=N'chihuytruongq9' ", connectionstring);
                    adapter.Fill(dataTable);
                ...
                else if (tenduyetb2.Text.Equals("Site P&G"))
                {
                    ...
                    SqlConnection conn = new SqlConnection(connectionstring);
                    DataTable dataTable = new DataTable();
                    SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles=N'chihuytruongpg'", connectionstring);
                    adapter.Fill(dataTable);
                    DropDownList1.DataSource = dataTable;
                    DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                    DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
                ...
                else if (tenduyetb2.Text.Equals("Site Đa Phước"))
                {
                    ...
                    SqlConnection conn = new SqlConnection(connectionstring);
                    DataTable dataTable = new DataTable();
                    SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles=N'chihuytruongdp'", connectionstring);
                    adapter.Fill(dataTable);
                    DropDownList1.DataSource = dataTable;
                    DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                    DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
                ...
                else if (tenduyetb2.Text.Equals("Site Glomed"))
                {
                    ...
                    SqlConnection conn = new SqlConnection(connectionstring);
                    DataTable dataTable = new DataTable();
                    SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles=N'chihuytruongglomed'", connectionstring);
                    adapter.Fill(dataTable);
                    DropDownList1.DataSource = dataTable;
                    DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                    DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
                ...
                else if (tenduyetb2.Text.Equals("Site SC Johnson"))
                {
                    ...
                    SqlConnection conn = new SqlConnection(connectionstring);
                    DataTable dataTable = new DataTable();
                    SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles=N'chihuytruongjohnson'", connectionstring);
                    adapter.Fill(dataTable);
                    DropDownList1.DataSource = dataTable;
                    DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                    DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
                        ...
                        else
                        {
                            ...
                            if (tenduyetb1.Text.Equals("nhanvien"))
                            {
                                if (tenduyetb2.Text.Equals("Site Quận 9"))
                                {
                                    ...
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Chưa Duyệt',N'" + username.ToString() + "',N'" + Label57.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'off',N'" + Label3.Text + "')", cnn))
                                    {
                                        ...
                                        while (reader5.Read())
                                        {
                                            Label6.Text = reader5["Tenduyetbuoc1"].ToString();
                                        }
                                        ...
                                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Chờ Xét Duyệt',N'" + nghichu1.Text.Trim() + "',N'NV','" + datacom + "','3cap','" + datetest + "')", cnn))
                                        {
                                ...
                                else if (tenduyetb2.Text.Equals("Site P&G"))
                                {
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Chưa Duyệt',N'" + username.ToString() + "',N'" + Label58.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'off',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
                                ...
                                else if (tenduyetb2.Text.Equals("Site Đa Phước"))
                                {
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Chưa Duyệt',N'" + username.ToString() + "',N'" + Label56.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'off',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
