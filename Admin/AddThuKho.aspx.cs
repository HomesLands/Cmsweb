...
namespace TBE.Admin
{
    public partial class AddThuKho : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'thukho' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            lvCustomers.DataSource = dt.Tables["Admin"];
        ...
        private void BindRepeater1()
        {
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' and Bophan=N'Site Glomed' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            ListView1.DataSource = dt.Tables["Admin"];
            ListView1.DataBind();
        }
        ...
        private void BindRepeater2()
        {
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' and Bophan=N'Site SC Johnson' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            ListView13.DataSource = dt.Tables["Admin"];
            ListView13.DataBind();
        }
        ...
        private void BindRepeater3()
        {
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' and Bophan=N'Site Đa Phước' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            ListView14.DataSource = dt.Tables["Admin"];
            ListView14.DataBind();
        }
        ...
        private void BindRepeater4()
        {
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' and Bophan=N'Site Abbott' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            ListView15.DataSource = dt.Tables["Admin"];
            ListView15.DataBind();
        }
        ...
        private void BindRepeater5()
        {
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'chihuytruong' and Bophan=N'Site Bia AB' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "Admin");
            ListView16.DataSource = dt.Tables["Admin"];
            ListView16.DataBind();
        }
        ...
        protected void btnViewOrders_Command(object sender, CommandEventArgs e)
        {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn1 = new SqlConnection(constr);
                string sql = "select  * from Admin where MaAD='" + e.CommandArgument + "'";
                SqlCommand cmd1 = new SqlCommand(sql, conn1);
                conn1.Open();
                SqlDataReader reader = cmd1.ExecuteReader();
                while (reader.Read())
                {
                    Label1.Text = reader["HoTen"].ToString();
                    Label2.Text = reader["Manager"].ToString();
                    bophan.Text = reader["Bophan"].ToString();
                }
                reader.Close();
                conn1.Close();
                if (bophan.Text.Equals("Văn Phòng"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "Userduyetdon");
                    if (adapter.Fill(dt) > 0)
                    {
                        Label4.Text = "User Đã Được Add Duyệt Đơn";
                    }
                    else
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhovp')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                        }
                    }
                } else if (bophan.Text.Equals("Site Quận 9"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhoq9')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site P&G"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhopg')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site Glomed"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhoglomed')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site SC Johnson"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhosc')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site Đa Phước"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhodaphuoc')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site Abbott"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhoabbott')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
                ...
                else if (bophan.Text.Equals("Site Bia AB"))
                {
                    SqlCommand cmd = new SqlCommand("select * from Nguoivanchuyen where Mauser='" + e.CommandArgument + "' ", cnn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    ...
                    {
                        using (var conn = new SqlDataAdapter("INSERT Nguoivanchuyen VALUES(N'" + e.CommandArgument + "',N'" + Label1.Text + "',N'thukhobiaab')", cnn))
                        {
                            var data = new DataTable();
                            conn.Fill(data);
                            Label4.Text = "Thêm Thành Công";
        ...
        protected void Button1_Command(object sender, CommandEventArgs e)
        {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                reader.Close();
                conn1.Close();
                using (var conn = new SqlDataAdapter("Delete from Nguoivanchuyen where Mauser='" + e.CommandArgument + "'", cnn))
                {
                    var data = new DataTable();
                    conn.Fill(data);
                    Label4.Text = "Xoá Thành Công";
                }
            }
        }
    }
