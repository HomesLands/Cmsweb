<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Viewphieuthu.aspx.cs" Inherits="Banhang.Admin.Viewphieuthu" %>
                                            ...
                                            <HeaderTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        ...
                                                        <th style="width: 150px; align-content: center;">Mã số</th>
                                                        <th style="width: 100px; align-content: center;">Đơn vị tính</th>
                                                        <th style="width: 100px; align-content: center;">Số lượng yêu cầu</th>
                                                        <th style="width: 100px; align-content: center;">Số lượng thực xuất</th>
                                                        <th style="width: 100px; align-content: center;">Đơn giá</th>
                                                        <th style="width: 100px; align-content: center;">Thành tiền</th>
                                                    </tr>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label6" runat="server"><%# Eval("Soluongyeucau") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label1" runat="server"><%# Eval("Soluongthucxuat") %></asp:Label>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <br />
                                                <br />
                                                <label class="bmd-label-floating" style="color: #000000; font-weight: bold;">Nguyễn Thị Thu Hà</label><br />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="bmd-label-floating" style="color: #000000; font-weight: bold;">NGƯỜI GIAO HÀNG</label><br />
                                                <label class="bmd-label-floating" style="color: #000000; font-style: italic;">&emsp;&emsp;Ký, họ tên</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="bmd-label-floating" style="color: #000000; font-weight: bold;">&emsp;THỦ KHO</label><br />
                                                ...
                                                <br />
                                                <br />
                                                <label class="bmd-label-floating" style="color: #000000; font-weight: bold;">Phạm Xuân Tuân</label><br />
                                            </div>
                                        </div>
                                    </div>
                                </div>
