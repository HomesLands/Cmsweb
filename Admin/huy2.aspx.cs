...
{
    public partial class huy2 : System.Web.UI.Page
    {
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                using (var conn2 = new SqlDataAdapter("update Phieuycvt set Duyet2len3=N'huygd',CKTP=N'" + mau + "',StatusGD=N'Hoàn Đơn',NDGGD=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Đã Duyệt Bước 2',StatusRecall=N'huy' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                {
                    ...
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Hoàn đơn về TPDA kiểm tra',N'" + lydoduyet.Text.Trim() + "',N'GD','" + datacom + "','0cap','" + datetest + "')", cnn))
                        {
        ...
        {
            Response.Redirect("~/Admin/Viewphieuycvt.aspx?idnsx=" + manotification.Text);
        }
    }   
    }
