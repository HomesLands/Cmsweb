<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ListUser.aspx.cs" Inherits="Banhang.Admin.ListUser" %>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="tennv" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">SDT</label>
                                            <asp:TextBox ID="sdt" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:Button ID="Button2" runat="server" Text="Tìm Kiếm" class="btn btn-primary pull-left" OnClick="Button2_Click" />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        ...
                                                        <th style="align-content: center;">Ảnh</th>
                                                        ...
                                                        <th style="align-content: center;">Bộ Phận</th>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image1" runat="server" Height="100px"
                                                        ImageUrl='<%# Eval("Anhuser") %>' Width="90px" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label2" runat="server"><%# Eval("Tenmanager") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server"><%# Eval("Bophan") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="ThongtinAdmin.aspx?idad=<%#Eval("MaAD") %>" data-tooltip="<%#Eval("MaAD") %>">Chi Tiết</a>
                                                </td>
                                                <td>
