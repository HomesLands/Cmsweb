<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="XuatBaoGia.aspx.cs" Inherits="Banhang.Admin.XuatBaoGia" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Model/Serial Number</label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:Button ID="Button3" runat="server" Text="Sreach" class="btn btn-primary pull-left" OnClick="Button3_Click" />
                                        </div>
                                    </div>
                                </div>
