...
namespace TBE.Admin
{
    public partial class PXK : System.Web.UI.Page
    {
        ...
        public void load()
        {
            ...
            reader.Close();
            conn1.Close();
            if (Label3.Text.Equals("khach")|| Label3.Text.Equals("nvhcns"))
            {
                danggiao.Visible = false;
                giaothatbai.Visible = false;
                thaygiaohang.Visible = false;
                nguoivanchuyen.Visible = false;
                thukho.Visible = false;
            }
            ...
            if (Label3.Text.Equals("ketoan")|| Label3.Text.Equals("muahang")|| Label3.Text.Equals("nvpda")||Label3.Text.Equals("it")|| Label3.Text.Equals("chihuytruong") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("thukho"))
            {
                danggiao.Visible = false;
                giaothatbai.Visible = false;
                thaygiaohang.Visible = false;
            ...
            if (Label3.Text.Equals("tpkehoach")|| Label3.Text.Equals("tpns")|| Label3.Text.Equals("ktt")|| Label3.Text.Equals("tpmh")|| Label3.Text.Equals("tpda")||Label3.Text.Equals("ppda"))
            {
                danggiao.Visible = false;
                giaothatbai.Visible = false;
                thaygiaohang.Visible = false;
        ...
        {
            Response.Redirect("~/Admin/Danggiao.aspx");
        }
        protected void giaothatbai_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/Giaothatbai.aspx");
        }
        protected void daxacnhan_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/TheodoidonPXK.aspx");
        }

        protected void nguoivanchuyen_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/Addgiaohang.aspx");
        }
        protected void thukho_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/AddThuKho.aspx");
        }

        protected void thaygiaohang_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/GiaoLai.aspx");
        }
    }
}