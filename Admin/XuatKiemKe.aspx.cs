...
{
    public partial class XuatKiemKe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    Label26.Text = "Welcome To " + " " + Session["ADminID"];
                    load();
        ...
        protected void load()
        {
            ...
            string sql = "select  * from KiemKe where Mahoadon='" + madon + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            ...
            while (reader.Read())
            {
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT * from KiemKe  where Mahoadon='" + madon + "' ", conn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "KiemKe");
                    Repeater2.DataSource = dt.Tables["KiemKe"];
                    Repeater2.DataBind();
                }
            }
            reader.Close();
        ...
        public void load1()
        {
            ...
            while (reader.Read())
            {
                Label27.Text = reader["Manager"].ToString();
                hotenad.Text = reader["HoTen"].ToString();
            }
            reader.Close();
            conn1.Close();
            if (Label27.Text.Equals("khach"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("ketoan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("muahang") || Label27.Text.Equals("giaonhan") || Label27.Text.Equals("it") || Label27.Text.Equals("thukho") || Label27.Text.Equals("thuquy") || Label27.Text.Equals("nvhcns") || Label27.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("chihuytruong"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("ppda") || Label27.Text.Equals("tpkehoach") || Label27.Text.Equals("tpda") || Label27.Text.Equals("tpmh") || Label27.Text.Equals("ktt") || Label27.Text.Equals("tpns"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("nhanvien") || Label27.Text.Equals("gsat") || Label27.Text.Equals("gsd") || Label27.Text.Equals("gsck") || Label27.Text.Equals("gs"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label27.Text.Equals("thohan") || Label27.Text.Equals("thocokhi") || Label27.Text.Equals("baotridien") || Label27.Text.Equals("baotricokhi") || Label27.Text.Equals("QSQC"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            conn.Close();
            string madon = Request.QueryString["idnsx"].ToString();
            string sql1 = "select  * from KiemKe where Mahoadon=@madon";
            ...
            while (reader1.Read())
            {
                ...
                Label17.Text = reader1["TenKho"].ToString();
                Label18.Text = reader1["Date"].ToString();
                Label19.Text = reader1["Diachicongty"].ToString();
                Label20.Text = reader1["DiachiKho"].ToString();
                Label21.Text = reader1["Nguoikiemke"].ToString();
                Label22.Text = reader1["Lydokiem"].ToString();
            }
            reader1.Close();
            conn.Close();
            if (marfid.Text != "")
            {
                if (adapter.Fill(dt) > 0)
                {
                    ...
                    {
                            SqlCommand cmdd = new SqlCommand("select * from KiemKe where MaRFID='" + marfid.Text + "' and Mahoadon='" + Label13.Text + "' ", conn);
                            SqlDataAdapter adapterr;
                            adapterr = new SqlDataAdapter(cmdd);
                            DataSet dtt = new DataSet();
                            adapterr.Fill(dtt, "KiemKe");
                            if (adapterr.Fill(dtt) > 0)
                            {
                                Label3.Visible = true;
                                Label3.Text = "Trùng Mã Kiểm Kê! Vui Lòng Chọn Lại Mã";
                                marfid.Text = "";
                                marfid.Focus();
                            }
                            else
                            {
                                using (var conn1 = new SqlDataAdapter("Insert KiemKe values('" + madon + "',N'" + Label16.Text.Trim() + "',N'" + Label17.Text.Trim() + "','" + Label18.Text.Trim() + "',1,N'" + Label19.Text.Trim() + "',N'" + Label20.Text.Trim() + "',N'" + Label21.Text.Trim() + "',N'" + Label22.Text.Trim() + "','" + txt_autocomplete.Text.Trim() + "','" + marfid.Text.Trim() + "',N'" + Label8.Text.Trim() + "',N'" + Label12.Text.Trim() + "')", conn))
                                {
                                    var data = new DataTable();
                                    conn1.Fill(data);
                                }
                                string ID1 = "mamacdinh";
                                using (var conn2 = new SqlDataAdapter("Delete from KiemKe where MaSP='" + ID1 + "' ", conn))
                                {
                                    var data = new DataTable();
                                    conn2.Fill(data);
                                }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ViewKiemKe.aspx?idnsx=" + masp);  
        }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
                ...
                reader1.Close();
                conn.Close();
                using (var conn2 = new SqlDataAdapter("Delete from KiemKe where Mahoadon='" + madon + "' and MaRFID='" + Label23.Text.Trim() + "' ", conn))
                {
                    var data = new DataTable();
                    conn2.Fill(data);
                    load();
