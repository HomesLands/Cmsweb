<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddNhaSanXuat.aspx.cs" Inherits="Banhang.Admin.AddNhaSanXuat" %>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="tenNSX" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label6" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <HeaderTemplate>
                                            <table class="table" border="1">
                                                <tr>
                                                    <th style="width: 70px; align-content: center;">Mã NSX</th>
                                                    <th style="width: 120px; align-content: center;">Tên NSX</th>
                                                    <th style="width: 120px; align-content: center;">Địa Chỉ</th>
                                                    <th style="width: 150px; align-content: center;">Điện Thoại</th>
                                                    <th style="width: 200px; align-content: center;">Email</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="tenid" runat="server"><%# Eval("MaSX") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label4" runat="server"><%# Eval("TenSX") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label7" runat="server"><%# Eval("DiaChi") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label8" runat="server"><%# Eval("DT") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label9" runat="server"><%# Eval("Email") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="ThôngTinNSX.aspx?idnsx=<%#Eval("MaSX") %>" data-tooltip="<%#Eval("MaSX") %>">Edit</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
