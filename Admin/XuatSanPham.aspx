<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="XuatSanPham.aspx.cs" Inherits="Banhang.Admin.XuatSanPham" %>
                                        ...
                                        <asp:Repeater ID="Repeater2" runat="server">
                                            <HeaderTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 20px; align-content: center;">STT</th>
                                                        <th style="width: 250px; align-content: center;">Tên nhãn hiệu, qui cách, phẩm chất vật tư(sản phẩm, hàng hóa)</th>
                                                        ...
                                                        <th style="width: 100px; align-content: center;">Chức năng</th>
                                                    </tr>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
