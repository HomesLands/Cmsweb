...
{
    public partial class huy1 : System.Web.UI.Page
    {
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
            {
                ...
                using (var conn2 = new SqlDataAdapter("update Phieuycvt set Duyet2len3=N'huytp',CKCHT=N'" + mau + "',StatusPKH=N'Hoàn Đơn',NDPKH=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Đã Duyệt Bước 1',StatusRecall=N'huy',StatusRead=N'off' where Mahoadon='" + madon.Text.Trim() + "' ", cnn))
                {
                    ...
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Hoàn đơn về CHT kiểm tra',N'" + lydoduyet.Text.Trim() + "',N'TPDA','" + datacom + "','1cap','" + datetest + "')", cnn))
                        {
