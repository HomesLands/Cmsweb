...
{
    public partial class ThongtinPrint : System.Web.UI.Page
    {
        ...
        public void load1()
        {
            ...
            if (Label10.Text.Equals("muahang") || Label10.Text.Equals("giaonhan") || Label10.Text.Equals("it") || Label10.Text.Equals("thukho") || Label10.Text.Equals("thuquy") || Label10.Text.Equals("nvhcns") || Label10.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        ...
        public void load()
        {
            ...
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("select DISTINCT QRcode from SanPhamTBE where MaSP='" + id + "' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
