<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ThongtinSanPham.aspx.cs" Inherits="Banhang.Admin.ThongtinSanPham" ValidateRequest="false" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" class="form-control"></asp:DropDownList>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">MaModel</label>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">SL Tồn</label>
                                            <asp:TextBox ID="slton" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lslton" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Ngày Nhập</label><br />
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="ghichu" runat="server" TabIndex="1" TextMode="MultiLine" Rows="5" class="form-control"></asp:TextBox>
                                ...
                                <asp:Button ID="gui" runat="server" OnClick="xoa_Click" class="btn btn-primary pull-left" Text="Xóa" />
                                <asp:Button ID="Button1" runat="server" OnClick="capnhat_Click" class="btn btn-primary pull-left" Text="Cập Nhật" />
                            </div>
                        </div>
                    </div>
                </div>
