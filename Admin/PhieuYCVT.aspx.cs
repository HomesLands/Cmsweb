...
{
    public partial class PhieuYCVT : System.Web.UI.Page
    {
        ...
        protected void load() {
            ...
            reader.Close();
            conn1.Close();
            if (Label3.Text.Equals("admin") || Label3.Text.Equals("giamdoc"))
            {
                string date = DateTime.Now.ToString("ddMMyyyy");
                load1();
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where StatusGD=N'Chưa Duyệt'  ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
                lvCustomers.DataSource = dt.Tables["Phieuycvt"];
                lvCustomers.DataBind();
            }
            else if (Label3.Text.Equals("kho") || Label3.Text.Equals("giaonhan") || Label3.Text.Equals("ketoan") || Label3.Text.Equals("muahang") || Label3.Text.Equals("chihuytruong") || Label3.Text.Equals("it") || Label3.Text.Equals("thukho") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("nvhcns") || Label3.Text.Equals("nvpda"))
            {
                string date = DateTime.Now.ToString("ddMMyyyy");
                load1();
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusPKH=N'Chưa Duyệt' ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
            ...
            else if (Label3.Text.Equals("nhanvien") || Label3.Text.Equals("gsat") || Label3.Text.Equals("gsd") || Label3.Text.Equals("gsck") || Label3.Text.Equals("gs")|| Label3.Text.Equals("thohan") || Label3.Text.Equals("thocokhi") || Label3.Text.Equals("baotridien") || Label3.Text.Equals("baotricokhi") || Label3.Text.Equals("QSQC"))
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusCHT=N'Chưa Duyệt'  ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
            ...
            else if (Label3.Text.Equals("ppda") || Label3.Text.Equals("tpkehoach") || Label3.Text.Equals("tpda") || Label3.Text.Equals("tpmh") || Label3.Text.Equals("ktt") || Label3.Text.Equals("tpns"))
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Username='" + username + "' and StatusGD=N'Chưa Duyệt'  ORDER BY Date DESC ", conn);
                SqlDataAdapter adapter;
                adapter = new SqlDataAdapter(cmd);
                DataSet dt = new DataSet();
                adapter.Fill(dt, "Phieuycvt");
        ...
        protected void lnkCustomize_Command(object sender, CommandEventArgs e)
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            string sql = "select  * from Phieuycvt where Mahoadon='" + e.CommandArgument.ToString() + "' ";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            conn1.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
                Label26.Text = reader["StatusCHT"].ToString();
                Label29.Text = reader["StatusPKH"].ToString();
                Label30.Text = reader["StatusGD"].ToString();
            }
            reader.Close();
            conn1.Close();
           // if (Label29.Text.Equals("Hoàn Đơn")|| Label26.Text.Equals("Hoàn Đơn") || Label30.Text.Equals("Hoàn Đơn")|| Label29.Text.Equals("Đã duyệt") || Label26.Text.Equals("Đã duyệt") || Label30.Text.Equals("Đã duyệt"))
           // {
            //    Response.Redirect("~/Admin/PhieuYCVT.aspx");
           // }
           // else
          //  { 
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                {
                    using (var conn = new SqlDataAdapter("Delete from Phieuycvt where Mahoadon='" + e.CommandArgument.ToString() + "'", cnn))
                    {
                    ...
                    using (var conn = new SqlDataAdapter("Delete from vattuyeucau where Mahoadon='" + e.CommandArgument.ToString() + "'", cnn))
                    {
                        var data = new DataSet();
                        conn.Fill(data);
                        load1();
