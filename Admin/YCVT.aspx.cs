...
{
    public partial class YCVT : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e) {
            Response.Redirect("~/Admin/AddPhieuYCVT.aspx");
        }

        protected void Button1_Click(object sender, EventArgs e) {
            Response.Redirect("~/Admin/UserYCMH.aspx");
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/daduyet.aspx");
        }

        protected void Button4_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/daduyet1.aspx");
        }

        protected void Button5_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/daduyet2.aspx");
        }

        protected void Button6_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/YCVTcomplete.aspx");
        }

        protected void Button11_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/AddPhieuYCVT1.aspx");
        }

        protected void Button12_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/AddPhieuYCVT2.aspx");
        }

        protected void Button9_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/donhuy.aspx");
        }

        protected void Button13_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/donhuy1.aspx");
        }

        protected void Button14_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/donhuy2.aspx");
        }
        ...
        {
            Response.Redirect("~/Admin/Theodoidonduyet.aspx");
        }

        protected void Button17_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/theodoidonhuy.aspx");
        }
        protected void Button7_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/duyetdon.aspx");//buton7
            
        }

        protected void Button8_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/duyetdon1.aspx");//buton 8
        }

        protected void Button10_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/duyetdon2.aspx");//button 10
        }

        protected void Button18_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/AddPhieuYCVT3.aspx");
        }
        ...
        {
            Response.Redirect("~/Admin/YCVThoanthanh.aspx");          
        }
    }     
    }
