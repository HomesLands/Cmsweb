...
{
    public partial class ViewKiemKe : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            while (reader.Read())
            {
                ...
                diachi.Text = reader["DiachiKho"].ToString();
                Date.Text = reader["Date"].ToString();
                sophieu.Text = reader["Mahoadon"].ToString();
                TenKho.Text = reader["TenKho"].ToString();
                nguoikiem.Text = reader["Nguoikiemke"].ToString();
                lydokiem.Text = reader["Lydokiem"].ToString();
