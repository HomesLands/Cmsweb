<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ThongtinAdmin.aspx.cs" Inherits="Banhang.Admin.ThongtinAdmin" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="password" runat="server" TabIndex="1" class="form-control" type="password"></asp:TextBox>
                                            ...
                                            <asp:Label ID="Label10" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DropDownList3" runat="server" Style="width: 250px;" class="form-control">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Bộ Phận:</label>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="ngaysinhtx" runat="server"  class="form-control"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender runat="server" BehaviorID="ngaysinhtx_CalendarExtender" TargetControlID="ngaysinhtx" ID="ngaysinhtx_CalendarExtender"></ajaxToolkit:CalendarExtender>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">CCCD/CMND</label>
                                            <asp:TextBox ID="CCCD" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="LCCCD" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
