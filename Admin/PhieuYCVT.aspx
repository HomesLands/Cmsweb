<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="PhieuYCVT.aspx.cs" Inherits="Banhang.Admin.PhieuYCVT" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Đơn Chưa Duyệt</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:ListView ID="lvCustomers" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnPagePropertiesChanging="lvCustomers_PagePropertiesChanging">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        ...
                                                        <th style="align-content: center;">Mã YCVT</th>
                                                        <th style="align-content: center;">Người Tạo</th>
                                                        <th style="align-content: center;">Ngày Tạo</th>
                                                        <th style="align-content: center;">Status CHT</th>
                                                        <th style="align-content: center;">Nội Dung CHT</th>
                                                        <th style="align-content: center;">Status TPDA</th>
                                                        <th style="align-content: center;">Nội Dung TPDA</th>
                                                        <th style="align-content: center;">Status GD</th>
                                                        <th style="align-content: center;">Nội Dung GD</th>
                                                        <th style="align-content: center;">Nghi Chú</th>
                                                        <th style="align-content: center;">Xem Đơn</th>
                                                        <th style="align-content: center;">Xóa Đơn</th>
                                                    </tr>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label9" runat="server"><%# Eval("Nguoiyeucau") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server"><%# Eval("Date") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server"><%# Eval("Tenduyetbuoc1") %></asp:Label>
                                                    <asp:Label ID="Label7" runat="server"><%# Eval("StatusCHT") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label10" runat="server"><%# Eval("NDCHT") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server"><%# Eval("Tenduyetbuoc2") %></asp:Label>
                                                    <asp:Label ID="Label11" runat="server"><%# Eval("StatusPKH") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label13" runat="server"><%# Eval("NDPKH") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label16" runat="server"><%# Eval("Tenduyetbuoc3") %></asp:Label>
                                                    <asp:Label ID="Label14" runat="server"><%# Eval("StatusGD") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label15" runat="server"><%# Eval("NDGGD") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server"><%# Eval("NDNYC") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="Viewphieuycvt.aspx?idnsx=<%#Eval("Mahoadon") %>" data-tooltip="<%#Eval("Mahoadon") %>">Xem Đơn</a>
                                                </td>
                                                <td>
                                                    <asp:LinkButton ID="lnkCustomize" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("Mahoadon") %>' runat="server" OnCommand="lnkCustomize_Command" OnClientClick="return confirm('Bạn có chắc muốn xóa?');"> </asp:LinkButton>
                                                </td>
                                            </ItemTemplate>
                                        </asp:ListView>
                                    </asp:Panel>
