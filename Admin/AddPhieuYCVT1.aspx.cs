...
{
    public partial class AddPhieuYCVT1 : System.Web.UI.Page
    {
        ...
        public void kiemtratencty()
        {
            ...
            reader.Close();
            conn1.Close();
            if (tenduyetb1.Text.Equals("chihuytruong") || tenduyetb1.Text.Equals("it") || tenduyetb1.Text.Equals("kho") || tenduyetb1.Text.Equals("ketoan") || tenduyetb1.Text.Equals("muahang") || tenduyetb1.Text.Equals("nvpda") || tenduyetb1.Text.Equals("nvhcns"))
            {
        ...
        private void LoadDataToDropDownList2()
        {
            ...
            reader.Close();
            conn1.Close();
            if (tenduyetb1.Text.Equals("it") || tenduyetb1.Text.Equals("nvhcns") || tenduyetb1.Text.Equals("giaonhan"))
            {
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                DataTable dataTable = new DataTable();
                SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles='tpns'", connectionstring);
                adapter.Fill(dataTable);
            ...
            else if (tenduyetb1.Text.Equals("ketoan") || tenduyetb1.Text.Equals("kho"))
            {
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                DataTable dataTable = new DataTable();
                SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles='ktt'", connectionstring);
                adapter.Fill(dataTable);
                DropDownList1.DataSource = dataTable;
                DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
            ...
            else if (tenduyetb1.Text.Equals("nvpda") || tenduyetb1.Text.Equals("chihuytruong"))
            {
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                DataTable dataTable = new DataTable();
                SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles='tpda'", connectionstring);
                adapter.Fill(dataTable);
                DropDownList1.DataSource = dataTable;
                DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
            ...
            else if (tenduyetb1.Text.Equals("muahang") || tenduyetb1.Text.Equals("thukho"))
            {
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                DataTable dataTable = new DataTable();
                SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where  Roles='tpkehoach'", connectionstring);
                adapter.Fill(dataTable);
                DropDownList1.DataSource = dataTable;
                DropDownList1.DataTextField = "Tenuser"; //Text hiển thị 
                DropDownList1.DataValueField = "Tenuser"; //Giá trị khi chọn
                        ...
                        else
                        {
                            ...
                            if (tenduyetb1.Text.Equals("chihuytruong") || tenduyetb1.Text.Equals("it") || tenduyetb1.Text.Equals("kho") || tenduyetb1.Text.Equals("ketoan") || tenduyetb1.Text.Equals("muahang") || tenduyetb1.Text.Equals("nvpda") || tenduyetb1.Text.Equals("nvhcns"))
                            {
                                if (tenduyetb2.Text.Equals("Văn Phòng"))
                                {
                                    ...
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + tk + "',N'Đã duyệt','OK',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Đã Duyệt Bước 1',N'" + username.ToString() + "',N'" + Label56.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        ...
                                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Chờ Xét Duyệt',N'" + nghichu1.Text.Trim() + "',N'CHT','" + datacom + "','2cap','" + datetest + "')", cnn))
                                        {
                                ...
                                else if (tenduyetb2.Text.Equals("Site Quận 9"))
                                {
                                    ...
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + tk + "',N'Đã duyệt','OK',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Đã Duyệt Bước 1',N'" + username.ToString() + "',N'" + Label57.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
                                ...
                                else if (tenduyetb2.Text.Equals("Site P&G"))
                                {
                                    ...
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + tk + "',N'Đã duyệt','OK',N'" + DropDownList1.Text.Trim() + "',N'Chưa Duyệt','','',N'Chưa Duyệt','',N'Đã Duyệt Bước 1',N'" + username.ToString() + "',N'" + Label58.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
