<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="TBE.Admin.Print" %>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" class="btn btn-primary pull-left" Text="Thêm Sản Phẩm Mới" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <HeaderTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        ...
                                                        <th style="width: 250px; align-content: center;">QRcode</th>
                                                        ...
                                                        <th style="width: 70px; align-content: center;">SL Tồn</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="ThongtinPrint.aspx?idSP=<%#Eval("MaSP") %>" data-tooltip="<%#Eval("MaSP") %>">In Mã</a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                    ...
                                    <cc1:CollectionPager ID="pager" runat="server" PageSize="25"></cc1:CollectionPager>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <asp:Button ID="btnPrint" runat="server" Text="Print" OnClientClick="return PrintRepeater();" class="btn btn-primary pull-left" />
                <script type="text/javascript">
                    function PrintRepeater() {
                        var repeater = document.getElementById('<%=pnlContents.ClientID %>');
                        var printWindow = window.open('', '', 'height=400,width=800');
                        printWindow.document.write('<html><head><title>TBE</title>');
                ...
                <script type="text/javascript">
                    function printColumns() {
                        var col1 = document.querySelectorAll("#hinhanh");
                        var printWindow = window.open('', '', 'height=500,width=500');
                        printWindow.document.write('<html><head><title>Table Content</title>');
                        printWindow.document.write('</head><body >');
                        for (var i = 0; i < col1.length; i++) {
                            //printWindow.document.write("<img>img 5:" + col5[i].innerText + "<img></br>");
                            printWindow.document.write("<img>" + col5[i].innerHTML + "<img></br>");
                        }
                        printWindow.document.write('</body></html>');
                        printWindow.document.close();
                        printWindow.print();
