...
namespace Banhang.Admin
{
    public partial class AddAdmin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    Image1.ImageUrl = anhload.Text;
                    Image1.Visible = false;
                    Image2.ImageUrl = anhload1.Text;
        ...
        public void load1()
        {
            ...
            if (Label16.Text.Equals("muahang") || Label16.Text.Equals("thukho") || Label16.Text.Equals("thuquy"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        ...
        protected void gui_Click(object sender, EventArgs e)
        {
            ...
            {
                Label5.Visible = true;
                Label5.Text = "Password Không Được Bỏ Trống";
                password.Focus();
            }
            ...
            if (FileUpload.HasFile)
            {
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                {
                    ...
                    //Password MD5
                    string fileName1 = "../AnhUser/user.png";
                    Image1.ImageUrl = fileName1;
                    string role = DropDownList1.SelectedValue.ToString().Trim();
                    string role1 = DropDownList1.SelectedItem.ToString().Trim();
                    string bophan = DropDownList2.SelectedValue.ToString().Trim();
                    using (var conn = new SqlDataAdapter("INSERT Admin VALUES('',N'" + tenad.Text.Trim() + "','" + ngaysinhtx.Text.Trim() + "','true','" + cmnd.Text.Trim() + "',N'" + diachi.Text.Trim() + "','" + sdt.Text.Trim() + "','" + email.Text.Trim() + "','" + usernbame.Text.Trim() + "','" + password.Text.Trim() + "',N'" + role + "',N'" + bophan + "',N'" + fileName + "',N'" + fileName1 + "',N'" + role1 + "','0')", cnn))
                    {
                        var data = new DataTable();
                        conn.Fill(data);
                    }
                    Label2.Text = "Chúc Mừng Bạn Thêm Admin Thành Công";
                    load();
                    Image1.Visible = true;
                    Image2.Visible = true;
                }
            ...
            else if (FileUpload1.HasFile)
            {
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                {
                    string fileName = "../Data Image/nyc.png";
                    Image2.ImageUrl = fileName;
                    //Password MD5
        ...
        protected void lvCustomers_PagePropertiesChanging(object sender, System.Web.UI.WebControls.PagePropertiesChangingEventArgs e)
        {
