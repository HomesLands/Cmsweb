<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddDuAn.aspx.cs" Inherits="Banhang.Admin.AddDuAn" %>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Dự Án</label>
                                            <asp:TextBox ID="MaDuAn" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                    ...
                    <div class="row" id="tui7" runat="server">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">                                 
                                </div>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <asp:ListView ID="lvCustomers" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnPagePropertiesChanging="lvCustomers_PagePropertiesChanging">
                                                <LayoutTemplate>
                                                    <table class="table" border="1">
                                                        <tr>
                                                            ...
                                                            <th style="align-content: center;">Mã Dự Án</th>
                                                            <th style="align-content: center;">Tên Dự Án</th>
                                                            <th style="align-content: center;">Ngày Bắt Đầu</th>
                                                            <th style="align-content: center;">Ngày Kết Thúc</th>
                                                            <th style="align-content: center;">Người Quản Lý</th>
                                                            <th style="align-content: center;">Người Giám Sát</th>
                                                            <th style="align-content: center;">Người Thực Thiện</th>
                                                            <th style="align-content: center;">Tiến Độ</th>
                                                            <th style="align-content: center;">Nghi Chú</th>
                                                            <th style="align-content: center;">Update</th>
                                                            <th style="align-content: center;">File Đính Kèm</th>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server"><%# Eval("MaDuAn") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label10" runat="server"><%# Eval("TenDuAn") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label11" runat="server"><%# Eval("DateStart") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label12" runat="server"><%# Eval("DateEnd") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label9" runat="server"><%# Eval("NguoiQuanLy") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label1" runat="server"><%# Eval("NguoiGiamSat") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label3" runat="server"><%# Eval("NguoiThucHien") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label5" runat="server"><%# Eval("TienDo") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label6" runat="server"><%# Eval("MoTa") %></asp:Label>
                                                    </td>
                                                    <td>
                                                        <a href="UpdateDuAn.aspx?idad=<%#Eval("MaDuAn") %>" data-tooltip="<%#Eval("MaDuAn") %>">Update</a>
                                                    </td>
                                                    <td>
                                                        <a href="<%#Eval("Upload") %>" data-tooltip="<%#Eval("Upload") %>">Dowload File</a>
                                                    </td>
                                                    <td>
                                                        <a href="KPI.aspx?idad=<%#Eval("MaDuAn") %>" data-tooltip="<%#Eval("MaDuAn") %>">Delete</a>
                                                    </td>
                                                </ItemTemplate>
                                            </asp:ListView>
                                        </asp:Panel>
