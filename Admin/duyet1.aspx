<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="duyet1.aspx.cs" Inherits="Banhang.Admin.duyet1" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Lý Do Duyệt</label>
                                ...
                                <asp:Button ID="gui" runat="server" OnClick="gui_Click" class="btn btn-primary pull-left" Text="Duyệt" />
