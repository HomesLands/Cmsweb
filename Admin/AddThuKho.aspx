<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddThuKho.aspx.cs" Inherits="TBE.Admin.AddThuKho" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <form id="frm" runat="server">
        ...
        <asp:Label ID="bophan" runat="server" Text="Label"></asp:Label>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <asp:Label ID="Label4" runat="server" Text="Label" Style="color: #FF0000; font-style: italic"></asp:Label>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:ListView ID="lvCustomers" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 30px; align-content: center;">STT</th>
                                                        <th style="width: 30px; align-content: center;">Mã User</th>
                                                        <th style="width: 300px; align-content: center;">Họ Và Tên</th>
                                                        <th style="width: 250px; align-content: center;">Quyền Hạn</th>
                                                        <th style="width: 250px; align-content: center;">Bộ Phận</th>
                                                        <th style="width: 30px; align-content: center;">Add Duyệt Đơn</th>
                                                        <th style="width: 30px; align-content: center;">Xoá Duyệt Đơn</th>
                                                    </tr>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <asp:Label ID="rt" runat="server"><%# Eval("MaAD") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server"><%# Eval("HoTen") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server"><%# Eval("Manager") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server"><%# Eval("Bophan") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnViewOrders" runat="server" class="btn btn-primary pull-left"
                                                        CommandArgument='<%# Eval("MaAD") %>' OnCommand="btnViewOrders_Command"
                                                        Text="ADD" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="Button1" runat="server" Text="Xoá" class="btn btn-primary pull-left" CommandArgument='<%# Eval("MaAD") %>' OnCommand="Button1_Command" />
                                                </td>
                                            </ItemTemplate>
                                        </asp:ListView>
                                        ...
                                        <asp:ListView ID="ListView13" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 30px; align-content: center;">STT</th>
                                        ...
                                        <asp:ListView ID="ListView14" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 30px; align-content: center;">STT</th>
                                         ...
                                         <asp:ListView ID="ListView15" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 30px; align-content: center;">STT</th>
                                        ...
                                        <asp:ListView ID="ListView16" runat="server" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
                                            <LayoutTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        <th style="width: 30px; align-content: center;">STT</th>
