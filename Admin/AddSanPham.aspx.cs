...
namespace Banhang.Admin
{
    public partial class AddSanPham : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    load1();
                    Label6.Text = "Welcome To " + " " + Session["ADminID"];
        ...
        public void load1()
        {
            ...
            while (reader.Read())
            {
                Label10.Text = reader["Manager"].ToString();
                hotenad.Text = reader["HoTen"].ToString();
            }
            reader.Close();
            conn1.Close();
            if (Label10.Text.Equals("khach"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("ketoan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("muahang") || Label3.Text.Equals("giaonhan") || Label10.Text.Equals("it") || Label10.Text.Equals("thukho") || Label10.Text.Equals("thuquy") || Label10.Text.Equals("nvhcns") || Label10.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("chihuytruong"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("ppda") || Label10.Text.Equals("tpkehoach") || Label10.Text.Equals("tpda") || Label10.Text.Equals("tpmh") || Label10.Text.Equals("ktt") || Label10.Text.Equals("tpns"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("nhanvien") || Label10.Text.Equals("gsat") || Label10.Text.Equals("gsd") || Label10.Text.Equals("gsck") || Label10.Text.Equals("gs"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label10.Text.Equals("thohan") || Label10.Text.Equals("thocokhi") || Label10.Text.Equals("baotridien") || Label10.Text.Equals("baotricokhi") || Label10.Text.Equals("QSQC"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        }
        ...
        private void BindListView()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    cmd.CommandText = "Select * from SanPhamTBE where trangthai='action' ORDER BY STT DESC";
                    cmd.Connection = con;
        ...
        protected void themNSX_Click(object sender, EventArgs e)
        {
            load1();
            Response.Redirect("~/Admin/AddNhaSanXuat.aspx");
        }
        protected void gui_Click(object sender, EventArgs e)
        {
            ...
            if (tensp.Text != "")
            {
                Ltensp.Visible = false;
            }
            if (ghichu.Text != "")
            {
                Lghichu.Visible = false;
            }
            if (tensp.Text.Equals(""))
            {
                Ltensp.Visible = true;
                Ltensp.Text = "Tên Sản Phẩm Không Được Bỏ Trống";
                tensp.Focus();
            }
            if (ghichu.Text.Equals(""))
            {
                Lghichu.Visible = true;
                Lghichu.Text = "Ghi chú Không Được Bỏ Trống";
                ghichu.Focus();
            }
            if (txt_autocomplete.Text.Equals(""))
            {
                Label8.Visible = true;
                Label8.Text = "Mã Sản Phẩm Không Được Bỏ Trống";
                txt_autocomplete.Focus();
            }
            if (TextBox3.Text.Equals(""))
            {
                Label3.Visible = true;
                Label3.Text = "Model/Serial Number Không Được Bỏ Trống";
                TextBox3.Focus();
            }
            else
            {
                    ...
                    //bar code
                    string barCode = txt_autocomplete.Text.Trim();                
                    using (Bitmap bitMap = new Bitmap(barCode.Length * 40, 80))
                    {
                        using (Graphics graphics = Graphics.FromImage(bitMap))
                        {
                            ...
                            bitMap.Save(Server.MapPath("~/Data Image/" + txt_autocomplete.Text + ".png"));
                            string Image1 = "/Data Image/" + txt_autocomplete.Text + ".png";
                            string dongias = dongia.Text.Trim() + TextBox1.Text.Trim();
                            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                            {
                                using (var conn = new SqlDataAdapter("Insert SanPhamTBE values('" + txt_autocomplete.Text.Trim() + "',N'" + DropDownList1.Text.Trim() + "','chuaxacdinh','" + TextBox3.Text.Trim() + "',N'" + tensp.Text.Trim() + "','" + date + "',1,N'" + dongias + "','" + txt_autocomplete.Text.Trim() + "',N'" + DropDownList2.Text.Trim() + "',N'" + ghichu.Text.Trim() + "','action')", cnn))
                                {
                                    var data = new DataTable();
                                    conn.Fill(data);
                                    BindListView();
                                    Label2.Text = "Chúc Mừng Bạn Thêm Sản Phẩm Thành Công";
                                }
                            } 
                        }
                  }                                  
        ...
        private void LoadDataToDropDownList()
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("Select MaSX,TenSX From NhaSanXuat", connectionstring);
            adapter.Fill(dataTable);
            DropDownList1.DataSource = dataTable;
            DropDownList1.DataTextField = "TenSX"; //Text hiển thị
            DropDownList1.DataValueField = "TenSX"; //Giá trị khi chọn
        ...
        private void LoadDataToDropDownList1()
        {
            ...
            DropDownList2.DataTextField = "Tenkho"; //Text hiển thị
            DropDownList2.DataValueField = "Tenkho"; //Giá trị khi chọn
        ...
        {
            load1();
            Response.Redirect("~/Admin/AddDiaChi.aspx");
        }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            if (FileUpload2.HasFile != false)
            {
                ...
                {
                    Label12.Text = "Vui Lòng Chọn File Excel !!!";
                }
                else
                {
                    ...
                    if (fileSize < 34097152)
                    {
                        ...
                        using (OleDbConnection excel_con = new OleDbConnection(conString))
                        {
                            try
                            {
                                ...
                                dtExcelData.Columns.AddRange(new DataColumn[13] { new DataColumn("STT", typeof(string)), 
                                new DataColumn("MaSP", typeof(string)),
                                new DataColumn("MaSX", typeof(string)),
                                new DataColumn("MaRFID", typeof(string)),
                                new DataColumn("MaModel", typeof(string)),
                                new DataColumn("TenSP", typeof(string)),
                                new DataColumn("NgayNhap", typeof(string)),
                                new DataColumn("SLTon", typeof(int)),
                                new DataColumn("DonGia", typeof(string)),
                                new DataColumn("QRcode", typeof(string)),
                                ...
                                using (SqlConnection con = new SqlConnection(consString))
                                {
                                    using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                                    {
                                        ...
                                        sqlBulkCopy.DestinationTableName = "dbo.SanPhamTBE";

                                        //[OPTIONAL]: Map the Excel columns with that of the database table
                                        sqlBulkCopy.ColumnMappings.Add("STT", "STT");
                                        sqlBulkCopy.ColumnMappings.Add("MaSP", "MaSP");
                                        sqlBulkCopy.ColumnMappings.Add("MaSX", "MaSX");
                                        sqlBulkCopy.ColumnMappings.Add("MaRFID", "MaRFID");
                                        sqlBulkCopy.ColumnMappings.Add("MaModel", "MaModel");
                                        sqlBulkCopy.ColumnMappings.Add("TenSP", "TenSP");
                                        sqlBulkCopy.ColumnMappings.Add("NgayNhap", "NgayNhap");
                                        sqlBulkCopy.ColumnMappings.Add("SLTon", "SLTon");
                                        ...
                                        con.Close();
                                        Response.Redirect("AddSanPham.aspx");
                                    }
                                }
                            }
            ...
            {
                Label12.Text = "Vui Lòng Chọn File Excel Update";
            }
        }
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM SanPhamTBE where trangthai='action' "))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            {
                                wb.Worksheets.Add(dt, "SanPhamTBE");
                                Response.Clear();
