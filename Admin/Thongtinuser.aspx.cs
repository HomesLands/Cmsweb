...
namespace Banhang.Admin
{
    public partial class Thongtinuser : System.Web.UI.Page
    {
        ...
        public void load1()
        {
            ...
            if (Label16.Text.Equals("kho"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("muahang") || Label16.Text.Equals("giaonhan") || Label16.Text.Equals("it") || Label16.Text.Equals("thukho") || Label16.Text.Equals("thuquy") || Label16.Text.Equals("nvhcns") || Label16.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("ketoan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label16.Text.Equals("ppda") || Label16.Text.Equals("tpkehoach") || Label16.Text.Equals("tpda") || Label16.Text.Equals("tpmh") || Label16.Text.Equals("ktt") || Label16.Text.Equals("tpns"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        ...
        protected void load()
        {
            ...
            Repeater1.DataSource = dt.Tables["Admin"];
            Repeater1.DataBind();
        }
    }
}