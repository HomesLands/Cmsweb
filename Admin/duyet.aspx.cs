...
{
    public partial class duyet : System.Web.UI.Page
    {
        ...
        public void load1() {
            ...
            while (reader1.Read())
            {
                Label4.Text = reader1["Tenduyetbuoc1"].ToString();
            }
            ...
            //Chống copy
            if (hotenad.Text.Equals(Label4.Text))
            {           
            }
            else
            {
        ...
        private void LoadDataToDropDownList2() {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("Select * From Userduyetdon where Roles='tpkehoach' or Roles='tpda' or Roles='tpmh' or Roles='ktt' or Roles='tpns' or Roles='ppda'", connectionstring);
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            while (reader.Read())
            {
                Label5.Text = reader["Anh"].ToString();
            }
            reader.Close();
            conn1.Close();
            ...
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString())) {
                    ...
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "Phieuycvt");               
                        using (var conn2 = new SqlDataAdapter("update Phieuycvt set StatusCHT=N'Đã duyệt',NDCHT=N'" + lydoduyet.Text.Trim() + "',Tenduyetbuoc2=N'" + DropDownList1.Text.Trim() + "',StatusYcvt=N'Đã Duyệt Bước 1',StatusRecall=N'xacnhan',StatusPKH=N'Chưa Duyệt',CKCHT=N'" + Label5.Text + "',StatusRead=N'on',Duyet2len3=N'off',Duyet1len2=N'off' where Mahoadon='" + madon.Text.Trim() + "' ", cnn)) {
                    ...
                    {
                        Label1.Visible = true;
                        Label1.Text = "Lý Do Duyệt Không Được Bỏ Trống";
                        lydoduyet.Focus();
                    }
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Đã duyệt',N'" + lydoduyet.Text.Trim() + "',N'CHT','" + datacom + "','2cap','" + datetest + "')", cnn))
                        {
