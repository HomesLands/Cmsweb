...
{
    public partial class XuatLuanChuyen : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    Label31.Text = "Welcome To " + " " + Session["ADminID"];
                    load();
        ...
        public void load1()
        {
            ...
            while (reader.Read())
            {
                Label32.Text = reader["Manager"].ToString();
                hotenad.Text = reader["HoTen"].ToString();
            }
            reader.Close();
            conn1.Close();
            if (Label32.Text.Equals("khach"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("ketoan"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("muahang") || Label32.Text.Equals("giaonhan") || Label32.Text.Equals("it") || Label32.Text.Equals("thukho") || Label32.Text.Equals("thuquy") || Label32.Text.Equals("nvhcns") || Label32.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("chihuytruong"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("ppda") || Label32.Text.Equals("tpkehoach") || Label32.Text.Equals("tpda") || Label32.Text.Equals("tpmh") || Label32.Text.Equals("ktt") || Label32.Text.Equals("tpns"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("nhanvien") || Label32.Text.Equals("gsat") || Label32.Text.Equals("gsd") || Label32.Text.Equals("gsck") || Label32.Text.Equals("gs"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            if (Label32.Text.Equals("thohan") || Label32.Text.Equals("thocokhi") || Label32.Text.Equals("baotridien") || Label32.Text.Equals("baotricokhi") || Label32.Text.Equals("QSQC"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
        }
        ...
        protected void load()
        {
            ...
            string sql = "select  * from Luanchuyen where Mahoadon='" + madon + "'";
            SqlCommand cmd1 = new SqlCommand(sql, conn1);
            ...
            while (reader.Read())
            {
                ...
                {
                    SqlConnection conn = new SqlConnection(connectionstring);
                    SqlCommand cmd = new SqlCommand("SELECT * from Luanchuyen where Mahoadon='" + madon + "' ", conn);
                    SqlDataAdapter adapter;
                    adapter = new SqlDataAdapter(cmd);
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "Luanchuyen");
                    Repeater2.DataSource = dt.Tables["Luanchuyen"];
                    Repeater2.DataBind();
                }
            }
            reader.Close();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where MaRFID='" + marfid.Text + "' and trangthai='action' ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            ...
            cmd1.Parameters.AddWithValue("@marfid", marfid.Text);
            conn.Open();
            SqlDataReader reader = cmd1.ExecuteReader();
            while (reader.Read())
            {
            ...
            conn.Close();
            string madon = Request.QueryString["idnsx"].ToString();
            string sql1 = "select  * from Luanchuyen where Mahoadon=@madon";
            ...
            while (reader1.Read())
            {
                ...
                Label19.Text = reader1["Diachicongty"].ToString(); 
                Label17.Text = reader1["Tenkhocu"].ToString();
                Label20.Text = reader1["DiachiKhocu"].ToString();
                Label26.Text = reader1["Tenkhomoi"].ToString();
                Label27.Text = reader1["DiachiKhomoi"].ToString();
                Label18.Text = reader1["Date"].ToString();
                Label28.Text = reader1["Thoihan"].ToString();                              
                Label21.Text = reader1["Nguoiquanly"].ToString();
                Label22.Text = reader1["Lydo"].ToString();
                Label29.Text = reader1["Mucdich"].ToString();
                Label30.Text = reader1["Tieude"].ToString();
            }
            reader1.Close();
            conn.Close();
            if (marfid.Text != "")
            {
                if (adapter.Fill(dt) > 0)
                {
                    ...
                    {
                            SqlCommand cmdd = new SqlCommand("select * from Luanchuyen where MaRFID='" + marfid.Text + "' and Mahoadon='" + Label13.Text + "' ", conn);
                            SqlDataAdapter adapterr;
                            adapterr = new SqlDataAdapter(cmdd);
                            DataSet dtt = new DataSet();
                            adapterr.Fill(dtt, "Luanchuyen");
                            if (adapterr.Fill(dtt) > 0)
                            {
                                Label3.Visible = true;
                                Label3.Text = "Trùng Mã ! Vui Lòng Chọn Lại Mã";
                                marfid.Text = "";
                                marfid.Focus();
                            }
                            else
                            {
                                using (var conn1 = new SqlDataAdapter("Insert Luanchuyen values('" + madon + "',N'" + Label30.Text.Trim() + "',N'" + Label16.Text.Trim() + "',N'" + Label19.Text.Trim() + "',N'" + Label29.Text.Trim() + "',N'" + Label22.Text.Trim() + "','" + Label18.Text.Trim() + "',N'" + Label28.Text.Trim() + "',N'" + Label17.Text.Trim() + "',N'" + Label20.Text.Trim() + "',N'" + Label21.Text.Trim() + "',N'" + Label26.Text.Trim() + "',N'" + Label27.Text.Trim() + "',1,'" + txt_autocomplete.Text.Trim() + "','" + marfid.Text.Trim() + "',N'" + Label8.Text.Trim() + "',N'" + Label12.Text.Trim() + "')", conn))
                                {
                                    var data = new DataTable();
                                    conn1.Fill(data);
                                }
                                string ID1 = "mamacdinh";
                                using (var conn2 = new SqlDataAdapter("Delete from Luanchuyen where MaSP='" + ID1 + "' ", conn))
                                {
                                    var data = new DataTable();
                                    conn2.Fill(data);
                                }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ViewLuanChuyen.aspx?idnsx=" + masp);  
        }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
                ...
                while (reader1.Read())
                {
                    Label23.Text = reader1["MaRFID"].ToString();                
                }
                reader1.Close();
                conn.Close();
                using (var conn2 = new SqlDataAdapter("Delete from Luanchuyen where Mahoadon='" + madon + "' and MaRFID='" + Label23.Text.Trim() + "' ", conn))
                {
                    var data = new DataTable();
                    conn2.Fill(data);
                    load();
