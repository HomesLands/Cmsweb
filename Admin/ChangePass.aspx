<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ChangePass.aspx.cs" Inherits="Banhang.Admin.ChangePass" ValidateRequest="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Đổi Password</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Password Cũ</label><br />
                                            <asp:TextBox ID="passcu" runat="server" class="form-control" TextMode="Password"></asp:TextBox>
                                            <ajaxToolkit:PasswordStrength ID="password_PasswordStrength" runat="server" BehaviorID="password_PasswordStrength" TargetControlID="passcu"></ajaxToolkit:PasswordStrength>
                                            <asp:Label ID="Lpasscu" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="passmoi" runat="server" class="form-control" TextMode="Password"></asp:TextBox>
                                            <ajaxToolkit:PasswordStrength ID="PasswordStrength1" runat="server" BehaviorID="password_PasswordStrength1" TargetControlID="passmoi"></ajaxToolkit:PasswordStrength>
                                            <asp:Label ID="Lpassmoi" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <asp:Button ID="doipass" runat="server" OnClick="doipass_Click" class="btn btn-primary pull-left" Text="Đổi Password" />
