...
namespace Banhang.Admin {
    public partial class capduyet2 : System.Web.UI.Page {
        ...
        private void BindRepeater() {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * from Admin where Manager=N'tpkehoach' or Manager=N'tpda' or Manager=N'tpmh'  or Manager=N'ktt' or Manager=N'tpns'", conn);
        ...
        protected void btnViewOrders_Command(object sender, CommandEventArgs e) {
            using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString())) {
                ...
                {
                    using (var conn = new SqlDataAdapter("INSERT Userduyetdon VALUES('" + e.CommandArgument + "',N'" + Label1.Text + "',N'" + Label2.Text + "')", cnn))
                    {
