...
namespace TBE.Admin
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!Page.IsPostBack)
                {
                    ...
                    masp.Attributes.Add("onkeypress", "return clickButton(event,'" + Button1.ClientID + "')");
                    RFID.Attributes.Add("onkeypress", "return clickButton(event,'" + Button1.ClientID + "')");
                    tensp.Attributes.Add("onkeypress", "return clickButton(event,'" + Button1.ClientID + "')");
                    load();
        ...
        public void load()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from SanPhamTBE where trangthai='action' ", conn1);
        ...
        public void load1()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where MaSP like '%" + masp.Text.Trim() + "%' and trangthai='action'   ", conn1);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "SanPhamTBE");
        ...
        public void load2()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where MaRFID like '%" + RFID.Text.Trim() + "%' and trangthai='action'   ", conn1);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "SanPhamTBE");
        ...
        public void load3()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("select * from SanPhamTBE where TenSP like N'%" + tensp.Text.Trim() + "%' and trangthai='action'   ", conn1);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "SanPhamTBE");
        ...
        {
            Response.Redirect("~/Admin/Nhapkho.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (masp.Text == "" || RFID.Text == "" || tensp.Text == "")
            {
        ...
        {
            Response.Redirect("~/Admin/PhieuKiemKe.aspx");
        }

        protected void Button9_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/AddSanPham.aspx");
        }

        protected void Button10_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/PhieuXuatKho.aspx");
        }

        protected void Button8_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/PhieuLuanChuyen.aspx");
        }
