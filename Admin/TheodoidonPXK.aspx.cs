...
namespace TBE.Admin
{
    public partial class TheodoidonPXK : System.Web.UI.Page
    {
        ...
        public void load1()
        {
            ...
            else if (Label3.Text.Equals("muahang") || Label3.Text.Equals("it") || Label3.Text.Equals("thukho") || Label3.Text.Equals("thuquy") || Label3.Text.Equals("nvhcns") || Label3.Text.Equals("nvpda"))
            {
                Response.Redirect("~/Admin/Chantruycap.aspx");
            }
            ...
            else if (Label3.Text.Equals("kho") || Label3.Text.Equals("giamdoc"))
            {
                ...
                var sqlda = new SqlDataAdapter("SELECT * from Xuatkho where StatusPXK=N'Xác Nhận Đơn' ORDER BY Date DESC", sqlcon);
            ...
            {
                var sqlcon = new SqlConnection(ConfigurationManager.ConnectionStrings["Tbecon"].ToString());
                var sqlda = new SqlDataAdapter("SELECT * from Xuatkho where StatusPXK=N'Xác Nhận Đơn' and Nguoigiaohanh=N'" + hotenad.Text + "' ORDER BY Date DESC", sqlcon);
                var dt1 = new DataTable();
                sqlda.Fill(dt1);
                lvCustomers.DataSource = dt1;
                lvCustomers.DataBind();
        ...
        protected void lvCustomers_PagePropertiesChanging1(object sender, PagePropertiesChangingEventArgs e)
        {
