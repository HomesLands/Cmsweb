...
{
    public partial class ViewLuanChuyen : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            while (reader.Read())
            {
                ...
                diachicongty.Text = reader["Diachicongty"].ToString();
                TenKhocu.Text = reader["Tenkhocu"].ToString();
                diachicu.Text = reader["DiachiKhocu"].ToString();
                TenKhomoi.Text = reader["Tenkhomoi"].ToString();
                diachimoi.Text = reader["DiachiKhomoi"].ToString();
                Date.Text = reader["Date"].ToString();
                Thoihan.Text = reader["Thoihan"].ToString();
                sophieu.Text = reader["Mahoadon"].ToString();
                nguoikiem.Text = reader["Nguoiquanly"].ToString();
                lydokiem.Text = reader["Lydo"].ToString();
                Mucdich.Text = reader["Mucdich"].ToString();
                Tieude.Text = reader["Tieude"].ToString();
                string ipsp = reader["MaSP"].ToString();
                if (ipsp.Equals("mamacdinh"))
                {
                    Response.Write("Chưa Có Thông Tin Cho Hóa Đơn Này");
                }
                else
                {
                    SqlConnection conn = new SqlConnection(connectionstring);
