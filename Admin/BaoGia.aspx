<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="BaoGia.aspx.cs" Inherits="Banhang.Admin.BaoGia" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Thêm Phiếu Báo Giá</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Đơn</label>
                                            <asp:TextBox ID="madon" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="req" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lreq" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="soevent" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lsoevent" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="subject" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lsubject" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Contactor</label>
                                            <asp:TextBox ID="contactor" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lcontactor" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="to" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lto" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Cc</label>
                                            <asp:TextBox ID="cc" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lcc" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="mobile" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lmobile" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Chữ Ký:</label>
                                            <asp:TextBox ID="chuky" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Lchuky" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <HeaderTemplate>
                                            <table class="table" border="1">
                                                <tr>
                                                    ...
                                                    <th style="width: 100px; align-content: center;">Xem Dơn</th>
                                                    <th style="width: 100px; align-content: center;">Thêm Sản Phẩm Vào Đơn</th>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label4" runat="server"><%# Eval("Madon") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="ViewBaoGia.aspx?idnsx=<%#Eval("Madon") %>" data-tooltip="<%#Eval("Madon") %>">Xem Đơn</a>
                                                </td>
                                                <td>
                                                    <a href="XuatBaoGia.aspx?idnsx=<%#Eval("Madon") %>" data-tooltip="<%#Eval("Madon") %>">Thêm Sp</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
