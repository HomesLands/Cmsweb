    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            while (reader.Read())
            {
                ...
                ngaysinhns.Text = reader["NgaySinh"].ToString();
        ...
        protected void xoa_Click(object sender, EventArgs e)
        {
            ...
            string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn = new SqlConnection(connectionstring);
            SqlCommand cmd = new SqlCommand("Delete from Admin where UserName=@user", conn);
            cmd.Parameters.AddWithValue("@user", id);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            ...
            adapter.Fill(dt);
            adapter.Dispose();
            Label2.Text = "Xóa Tài Khoản Thành Công";
            Response.Redirect("~/Admin/Default.aspx");
        }
        protected void capnhat_Click1(object sender, EventArgs e)
        {
            if (tenad.Text != "")
            {
            ...
            {
                Label1.Visible = true;
                Label1.Text = "Tên Tài Khoản Không Được Bỏ Trống";
                tenad.Focus();
            }
            ...
            if (FileUpload1.HasFile)
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@hoten,NgaySinh=@ngaysinh,GioiTinh=@gioitinh,CMND=@cmnd,DiaChi=@diachi,DT=@dienthoai,Email=@email,Anhuser=@anhuser where UserName=@username";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@username", id);
                cmd.Parameters.AddWithValue("@hoten", tenad.Text.Trim());
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhns.Text.Trim());
                cmd.Parameters.AddWithValue("@gioitinh", DropDownList1.Text.Trim());
                cmd.Parameters.AddWithValue("@cmnd", cmnd.Text.Trim());
                cmd.Parameters.AddWithValue("@diachi", diachi.Text.Trim());
                cmd.Parameters.AddWithValue("@dienthoai", sdt.Text.Trim());
                cmd.Parameters.AddWithValue("@email", email.Text.Trim());
                cmd.Parameters.AddWithValue("@anhuser", fileName1);
                conn.Open();
                cmd.ExecuteNonQuery();
                conn.Close();
                Label4.Text = "Chúc Mừng Bạn Thay đổi Thông Tin Tài Khoản Thành Công";
            ...
            else if (FileUpload.HasFile)
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@hoten,NgaySinh=@ngaysinh,GioiTinh=@gioitinh,CMND=@cmnd,DiaChi=@diachi,DT=@dienthoai,Email=@email,Anh=@anh where UserName=@username";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@username", id);
                cmd.Parameters.AddWithValue("@hoten", tenad.Text.Trim());
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhns.Text.Trim());
            ...
            else if (FileUpload.HasFile != false && FileUpload1.HasFile != false)
            {
                ...
                string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                SqlConnection conn = new SqlConnection(connectionstring);
                string sql = "update Admin set HoTen=@hoten,NgaySinh=@ngaysinh,GioiTinh=@gioitinh,CMND=@cmnd,DiaChi=@diachi,DT=@dienthoai,Email=@email,Anh=@anh,Anhuser=@anhuser where UserName=@username";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@username", id);
                cmd.Parameters.AddWithValue("@hoten", tenad.Text.Trim());
                cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhns.Text.Trim());
            ...
            else
            {
                String id = Session["ADminID"].ToString();
                        string connectionstring = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
                        SqlConnection conn = new SqlConnection(connectionstring);
                        string sql = "update Admin set HoTen=@hoten,NgaySinh=@ngaysinh,GioiTinh=@gioitinh,CMND=@cmnd,DiaChi=@diachi,DT=@dienthoai,Email=@email where UserName=@username";
                        SqlCommand cmd = new SqlCommand(sql, conn);
                        cmd.Parameters.AddWithValue("@username", id);
                        cmd.Parameters.AddWithValue("@hoten", tenad.Text.Trim());
                        cmd.Parameters.AddWithValue("@ngaysinh", ngaysinhns.Text.Trim());
