...
namespace Banhang.Admin {
    public partial class donhuy2 : System.Web.UI.Page {
        ...
        protected void load() {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where Tenduyetbuoc3=N'" + hotenad.Text.Trim() + "' and StatusRecall=N'huy' and Display='on' ORDER BY Date DESC ", conn);
