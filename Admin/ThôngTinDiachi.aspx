<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="ThôngTinDiachi.aspx.cs" Inherits="Banhang.Admin.ThôngTinDiachi" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Thông Tin Địa Chỉ Kho</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="tenkho" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Ltenkho" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                ...
                                <asp:Button ID="gui" runat="server" OnClick="xoa_Click" class="btn btn-primary pull-right" Text="Xóa" />
                                <asp:Button ID="Button1" runat="server" OnClick="capnhat_Click" class="btn btn-primary pull-right" Text="Cập Nhật" />
