<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="capduyet1.aspx.cs" Inherits="Banhang.Admin.capduyet1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <form id="frm" runat="server">
        ...
        <asp:Label ID="hotenad" runat="server" Text="Label"></asp:Label>
         <asp:Label ID="rolect" runat="server" Text="Label"></asp:Label>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" class="btn btn-primary pull-left" Text="Add User" />
