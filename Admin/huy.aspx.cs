...
{
    public partial class huy : System.Web.UI.Page
    {
        ...
        protected void gui_Click(object sender, EventArgs e) {
                ...
                using (var conn2 = new SqlDataAdapter("update Phieuycvt set Duyet2len3=N'huy1',CKNYC=N'" + mau + "',StatusCHT=N'Hoàn Đơn',NDCHT=N'" + lydoduyet.Text.Trim() + "', StatusYcvt=N'Chưa Duyệt',StatusRecall=N'huy',StatusNYC=N'noplai' where Mahoadon='" + madon.Text.Trim() + "' ", cnn)) {
                    ...
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Hủy',N'" + lydoduyet.Text.Trim() + "',N'CHT','" + datacom + "','2cap','" + datetest + "')", cnn))
                        {
