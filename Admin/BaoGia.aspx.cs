...
namespace Banhang.Admin
{
    public partial class BaoGia : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT Madon from PhieuXuatkho ", conn);
            SqlDataAdapter adapter;
            adapter = new SqlDataAdapter(cmd);
            DataSet dt = new DataSet();
            adapter.Fill(dt, "PhieuXuatkho");
            Repeater1.DataSource = dt.Tables["PhieuXuatkho"];
            Repeater1.DataBind();
        }
        public void load1()
        {
        ...
        protected void gui_Click(object sender, EventArgs e)
        {
            ...
            if (soevent.Text != "")
            {
                Lsoevent.Visible = false;
            }
            if (contactor.Text != "")
            {
                Lcontactor.Visible = false;
            }
            if (to.Text != "")
            {
                Lto.Visible = false;
            ...
            if (chuky.Text != "")
            {
                Lchuky.Visible = false;
            }
            if (madon.Text.Equals(""))
            {
                Lmadon.Visible = true;
                Lmadon.Text = "Mã Đơn Không Được Bỏ Trống";
                madon.Focus();
            }
            if (req.Text.Equals(""))
             {
                 Lreq.Visible = true;
                 Lreq.Text = "Req Không Được Bỏ Trống";
                 req.Focus();
             }
            ...
            if (soevent.Text.Equals(""))
            {
                Lsoevent.Visible = true;
                Lsoevent.Text = "Event Không Được Bỏ Trống";
                soevent.Focus();
            }
            if (subject.Text.Equals(""))
            {
                Lsubject.Visible = true;
                Lsubject.Text = "Subject Không Được Bỏ Trống";
                subject.Focus();
            }
            if (contactor.Text.Equals(""))
            {
                Lcontactor.Visible = true;
                Lcontactor.Text = "Contactor Không Được Bỏ Trống";
                contactor.Focus();
            }
            if (to.Text.Equals(""))
            {
                Lto.Visible = true;
                Lto.Text = "To Không Được Bỏ Trống";
                to.Focus();
            }
            if (cc.Text.Equals(""))
            {
                Lcc.Visible = true;
                Lcc.Text = "Cc Không Được Bỏ Trống";
                cc.Focus();
            }
            if (mobile.Text.Equals(""))
            {
                Lmobile.Visible = true;
                Lmobile.Text = "Số Điện Thoại Không Được Bỏ Trống";
                mobile.Focus();
            }
            if (chuky.Text.Equals(""))
            {
                Lchuky.Visible = true;
                Lchuky.Text = "Nội Dung Không Được Bỏ Trống";
                chuky.Focus();
            }
            ...
            else
            {
                ...
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString()))
                    {
                        using (var conn = new SqlDataAdapter("Insert PhieuXuatkho values('" + madon.Text.Trim() + "','" + req.Text.Trim() + "',N'" + tieude.Text.Trim() + "',N'" + soevent.Text.Trim() + "',N'" + subject.Text.Trim() + "','" + to.Text.Trim() + "','" + cc.Text.Trim() + "','" + datet + "',N'" + contactor.Text.Trim() + "','" + mobile.Text.Trim() + "',N'" + chuky.Text.Trim() + "','','')", cnn))
                        {
