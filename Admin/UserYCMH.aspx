<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="UserYCMH.aspx.cs" Inherits="Banhang.Admin.UserYCMH" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <asp:Button ID="Button7" runat="server" OnClick="Button10_Click" class="btn btn-primary pull-left" Text="Duyệt Cấp 1" />
                                <asp:Button ID="Button8" runat="server" OnClick="Button7_Click" class="btn btn-primary pull-left" Text="Duyệt Cấp 2" />
                                <asp:Button ID="Button10" runat="server" OnClick="Button8_Click" class="btn btn-primary pull-left" Text="Duyệt Cấp 3" />
