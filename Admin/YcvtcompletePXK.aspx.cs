...
namespace TBE.Admin
{
    public partial class YcvtcompletePXK : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT Nguoiyeucau,NDNYC,Mahoadon,Date,Tenduyetbuoc1,StatusCHT,NDCHT,Tenduyetbuoc2,StatusPKH,NDPKH,Tenduyetbuoc3,StatusGD,NDGGD from Phieuycvt where StatusYcvt=N'Đã Duyệt1' or StatusYcvt=N'donthieu' ORDER BY Date DESC ", conn);
