<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddDiaChi.aspx.cs" Inherits="Banhang.Admin.AddDiaChi" %>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="tendiachi" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Ltendiachi" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Địa Chỉ Kho</label>
                                            <asp:TextBox ID="diachikho" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Ldiachikho" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <HeaderTemplate>
                                            <table class="table" border="1">
                                                <tr>
                                                    <th style="width: 70px; align-content: center;">Mã Địa Chỉ</th>
                                                    <th style="width: 120px; align-content: center;">Tên Địa Chỉ</th>
                                                    <th style="width: 120px; align-content: center;">Địa Chỉ Kho</th>
                                                    <th style="width: 50px; align-content: center;">Chức Năng</th>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="tenid" runat="server"><%# Eval("Madt") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label4" runat="server"><%# Eval("Tenkho") %></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label7" runat="server"><%# Eval("Diachi") %></asp:Label>
                                                </td>
                                                <td>
                                                    <a href="ThôngTinDiachi.aspx?idnsx=<%#Eval("Madt") %>" data-tooltip="<%#Eval("Madt") %>">Edit</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
