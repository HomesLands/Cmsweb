...
{
    public partial class Chantruycap : System.Web.UI.Page
    {
        ...
        public void loadicon()
        {
            ...
            Label3.Text = "Bạn Không Có Quyền Truy Cập Trang Này. Máy"+ "&nbsp" + lblHostName.Text + "&nbsp" + "IP " + lblIP.Text + "&nbsp" + "Đã Được Nghi Nhận Lại...";
        }
        public void load()
        {
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
