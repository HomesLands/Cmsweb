<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="huy4.aspx.cs" Inherits="Banhang.Admin.huy4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <form id="frm" runat="server">
        ...
        <asp:Label ID="huynotification" runat="server" Text="0"></asp:Label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="lydoduyet" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                            <asp:Label ID="Label1" runat="server" Text="Label" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <asp:Button ID="gui" runat="server" OnClick="gui_Click" class="btn btn-primary pull-left" Text="Xác Nhận" />
