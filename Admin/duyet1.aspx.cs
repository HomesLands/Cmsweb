...
{
    public partial class duyet1 : System.Web.UI.Page
    {
        ...
        public void load1() {
            ...
            while (reader1.Read())
            {
                Label4.Text = reader1["Tenduyetbuoc2"].ToString();
            }
            reader1.Close();
            conn11.Close();
        ...
        protected void gui_Click(object sender, EventArgs e) {
            ...
            madon.Text = Request.QueryString["idnsx"].ToString(); 
                ...
                using (var cnn = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Tbecon"].ToString())) {
                    ...
                    DataSet dt = new DataSet();
                    adapter.Fill(dt, "Phieuycvt");
                    using (var conn2 = new SqlDataAdapter("update Phieuycvt set StatusPKH=N'Đã duyệt',NDPKH=N'" + lydoduyet.Text.Trim() + "',Tenduyetbuoc3=N'" + DropDownList1.Text.Trim() + "',StatusYcvt=N'Đã Duyệt Bước 2',StatusRecall=N'xacnhan',StatusGD=N'Chưa Duyệt',CKTP=N'" + Label5.Text + "',StatusRead=N'on',Duyet1len2=N'on',Duyet2len3=N'off' where Mahoadon='" + madon.Text.Trim() + "' ", cnn)) {
                    ...
                    else
                    {
                        ...
                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + Label6.Text.Trim() + "',N'Đã duyệt',N'" + lydoduyet.Text.Trim() + "',N'TPDA','" + datacom + "','1cap','" + datetest + "')", cnn))
                        {
