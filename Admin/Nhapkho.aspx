<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Nhapkho.aspx.cs" Inherits="Banhang.Admin.Nhapkho" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <asp:Button ID="Button2" runat="server" OnClick="themNSX_Click" class="btn btn-primary pull-left" Text="Thêm NCC" />
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Mã Sản Phẩm</label><br />
                                            ...
                                            <asp:Button ID="Button3" runat="server" Text="Tìm Kiếm" class="btn btn-primary pull-left" OnClick="Button3_Click" />
                                            <asp:Label ID="Label11" runat="server" Text="Label"></asp:Label>
                                            <asp:Label ID="trangthairfid" runat="server" Text="Label"></asp:Label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="TextBox2" runat="server" TabIndex="1" class="form-control" MaxLength="22"></asp:TextBox>
                                            <asp:Button ID="Button4" runat="server" Text="Thêm" class="btn btn-primary pull-left" OnClick="Button4_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Model/Serial Number</label><br />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">SL Tồn</label><br />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtPlaces" runat="server" TabIndex="1" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Nhà Cung Cấp</label><br />
                                            <asp:DropDownList ID="DropDownList1" runat="server" Style="width: 170px;" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <asp:Label ID="Label2" runat="server" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                <div class="clearfix"></div>
                                <asp:Label ID="Label8" runat="server" Text="Label" Style="color: #FF0000; font-style: italic" class="bmd-label-floating"></asp:Label>
                                <br />
                                <br />
                                            ...
                                            <HeaderTemplate>
                                                <table class="table" border="1">
                                                    <tr>
                                                        ...
                                                        <th style="width: 70px; align-content: center;">Chức năng</th>
                                                    </tr>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="delete" OnClientClick='javascript:return confirm("Bạn Có Chắc Muốn Xóa?")' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "MaRFID") %>'>Delete</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
