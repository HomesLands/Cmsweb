...
{
    public partial class AddPhieuYCVT3 : System.Web.UI.Page
    {
        ...
        public void kiemtratencty()
        {
            ...
            reader.Close();
            conn1.Close();
            if (tenduyetb1.Text.Equals("giamdoc") || tenduyetb1.Text.Equals("admin"))
            {
        ...
        public void tk()
        {
            Label16.Text = "Nguyễn Thị Thu Hà";
            string constr = ConfigurationManager.ConnectionStrings["Tbecon"].ConnectionString;
            SqlConnection conn1 = new SqlConnection(constr);
            string username = Session["ADminID"].ToString();
                        ...
                        else
                        {
                            ...
                            if (tenduyetb1.Text.Equals("giamdoc") || tenduyetb1.Text.Equals("admin"))
                            {
                                if (tenduyetb2.Text.Equals("Văn Phòng"))
                                {
                                    ...
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt',N'OK',N'Đã Duyệt',N'" + username.ToString() + "',N'" + Label56.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + Label28.Text + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        ...
                                        using (var conn3 = new SqlDataAdapter("INSERT Comment VALUES(N'" + ttts + "',N'" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Đã Hoàn Thành',N'" + nghichu1.Text.Trim() + "',N'GD','" + datacom + "','0cap','" + datetest + "')", cnn))
                                        {
                                ...
                                else if (tenduyetb2.Text.Equals("Site Quận 9"))
                                {
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt',N'OK',N'Đã Duyệt',N'" + username.ToString() + "',N'" + Label57.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + Label28.Text + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
                                ...
                                else if (tenduyetb2.Text.Equals("Site P&G"))
                                {
                                    string urllink = "~/Admin/Viewphieuycvt.aspx?idnsx=" + madon.Text + "";
                                    string date = DateTime.Now.ToString("ddMMyyyy");
                                    using (var conn = new SqlDataAdapter("Insert Phieuycvt values('" + madon.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'" + xuatct.Text.Trim() + "',N'" + datet + "',N'" + Duan.Text.Trim() + "',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt','OK',N'" + hotenad.Text.Trim() + "',N'Đã duyệt',N'OK',N'Đã Duyệt',N'" + username.ToString() + "',N'" + Label58.Text + "',N'xacnhan',N'danop',N'" + nghichu1.Text + "',N'" + Label28.Text + "',N'" + mau + "',N'" + mau + "',N'" + Label28.Text + "',N'" + mau + "',N'off',N'" + urllink + "',N'off',N'off',N'on',N'" + Label3.Text + "')", cnn))
                                    {
                                        var data = new DataTable();
                                        conn.Fill(data);
                                        abc.Visible = true;
